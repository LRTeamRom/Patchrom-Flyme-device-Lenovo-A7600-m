...
.field private static p2pOperFreq:I
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/server/wifi/WifiMonitor;->p2pOperFreq:I
...
.method private handleP2pEvents(Ljava/lang/String;)V
    ...
    .line 1287
    .local v4, "p2pStatus":Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStatus;
    iget-object v6, p0, Lcom/android/server/wifi/WifiMonitor;->mStateMachine:Lcom/android/internal/util/StateMachine;

    const v7, 0x2401a

    sget v8, Lcom/android/server/wifi/WifiMonitor;->p2pOperFreq:I

    invoke-virtual {v6, v7, v8, v10, v4}, Lcom/android/internal/util/StateMachine;->sendMessage(IIILjava/lang/Object;)V

    .line 1288
    sput v11, Lcom/android/server/wifi/WifiMonitor;->p2pOperFreq:I

    goto :goto_0

    .line 1290
    .end local v4    # "p2pStatus":Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStatus;
    :cond_6
    ...
    .line 1296
    .restart local v4    # "p2pStatus":Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStatus;
    iget-object v6, p0, Lcom/android/server/wifi/WifiMonitor;->mStateMachine:Lcom/android/internal/util/StateMachine;
    ...
    invoke-virtual {v6, v7, v0}, Lcom/android/internal/util/StateMachine;->sendMessage(ILjava/lang/Object;)V
    ...
    :cond_13
    const-string v6, "CTRL-EVENT-DISCONNECTED"
    ...
    .line 1355
    .local v3, "nameValueTwo":[Ljava/lang/String;
    ...
    sput v6, Lcom/android/server/wifi/WifiMonitor;->p2pOperFreq:I
    ...
    const-string v8, "p2pOperFreq@CTRL-EVENT-DISCONNECTED-1 = "
    ...
    .line 1361
    .end local v3    # "nameValueTwo":[Ljava/lang/String;
    :cond_14
    array-length v6, v5
    ...
    .line 1364
    .local v2, "nameValueThree":[Ljava/lang/String;
    ...
    const-string v8, "p2pOperFreq@CTRL-EVENT-DISCONNECTED-2 = "
    ...
    .line 1370
    .end local v2    # "nameValueThree":[Ljava/lang/String;
    :cond_15
    iget-object v6, p0, Lcom/android/server/wifi/WifiMonitor;->mStateMachine:Lcom/android/internal/util/StateMachine;
    ...
    invoke-virtual {v6, v7, v8, v10, v9}, Lcom/android/internal/util/StateMachine;->sendMessage(IIILjava/lang/Object;)V
    ...
    :cond_16
    const-string v6, "P2P-GO-IP-ALLOCATE"
    ...
    const-string v7, "handleP2pEvents, send P2P_GO_IP_ALLOCATE_EVENT"
    ...
    const-string v7, "handleP2pEvents, send P2P_GC_IP_GET_EVENT"
    ...
    invoke-virtual {v6, v7, p1}, Lcom/android/internal/util/StateMachine;->sendMessage(ILjava/lang/Object;)V

    goto/16 :goto_0

    .line 1380
    :cond_18
    const-string v6, "P2P-NFC-GO-INVITED"
...
.method private p2pErrorEx(Ljava/lang/String;)Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStatus;
    ...
    const-string v7, "peer_oper_freq format is wrong-1 @p2pErrorEx() ==> "
    ...
    .restart local v3    # "nameValueTwo":[Ljava/lang/String;
    :cond_2
    aget-object v5, v4, v8
    ...
    const-string v7, "peer_oper_freq format is wrong-2 @p2pErrorEx() ==> "
    ...
    const-string v7, "peer_oper_freq format is wrong-3 @p2pErrorEx() ==> "
    ...
    sput v5, Lcom/android/server/wifi/WifiMonitor;->p2pOperFreq:I
    ...
    const-string v7, "p2pOperFreq@p2pErrorEx() = "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    sget v7, Lcom/android/server/wifi/WifiMonitor;->p2pOperFreq:I
...
.method private p2pError_GroupRemove(Ljava/lang/String;)Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStatus;
    ...
    const-string v7, "peer_oper_freq format is wrong-1 @p2pError_GroupRemove() ==> "
    ...
    const-string v7, "peer_oper_freq format is wrong-2 @p2pError_GroupRemove() ==> "
    ...
    const-string v7, "peer_oper_freq format is wrong-3 @p2pError_GroupRemove() ==> "
    ...
    const-string v7, "p2pOperFreq@p2pError_GroupRemove() = "
