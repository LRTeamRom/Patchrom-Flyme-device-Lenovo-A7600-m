...
.method static constructor <clinit>()V
    ...
    .line 145
    sput-boolean v3, Lcom/android/server/wifi/WifiConfigStore;->VVDBG:Z
...
.method static synthetic access$300(Lcom/android/server/wifi/WifiConfigStore;Ljava/io/DataOutputStream;II)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/wifi/WifiConfigStore;
...
.method private addOrUpdateNetworkNative(Landroid/net/wifi/WifiConfiguration;I)Lcom/android/server/wifi/NetworkUpdateResult;
    ...
    .prologue
    .line 2688
    sget-boolean v27, Lcom/android/server/wifi/WifiConfigStore;->VDBG:Z
    ...
    const-string v28, "addOrUpdateNetworkNative "
    ...
    .line 2699
    .local v24, "test":Landroid/net/wifi/WifiConfiguration;
    ...
    const-string v28, " was found, but no network Id"
    ...
    .end local v24    # "test":Landroid/net/wifi/WifiConfiguration;
    :cond_2
    if-eqz v23, :cond_5
    ...
    const-string v28, "Setting BSSID for "
    ...
    const-string v28, "failed to set BSSID: "
    ...
    const-string v28, "Failed to set a network variable, removed network: "
    ...
    .line 3004
    :cond_4
    new-instance v22, Lcom/android/server/wifi/NetworkUpdateResult;
    ...
    invoke-virtual/range {v27 .. v27}, Lcom/android/server/wifi/WifiNative;->addNetwork()I
    ...
    .line 2713
    const-string v27, "Failed to add a network!"
    ...
    const-string v28, "addOrUpdateNetworkNative created netId="
    ...
    .line 2735
    .end local v23    # "savedNetId":Ljava/lang/Integer;
    .restart local v25    # "updateFailed":Z
    :cond_7
    move-object/from16 v0, p1
    ...
    const-string v28, "failed to set SSID: "
    ...
    invoke-static/range {v27 .. v28}, Lcom/android/server/wifi/WifiConfigStore;->makeString(Ljava/util/BitSet;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual/range {v27 .. v27}, Ljava/util/BitSet;->cardinality()I
    ...
    const-string v28, "failed to set key_mgmt: "
    ...
    const-string v28, "failed to set proto: "
    ...
    const-string v28, "failed to set auth_alg: "
    ...
    const-string v28, "failed to set pairwise: "
    ...
    const-string v28, "failed to set group: "
    ...
    sget-object v28, Landroid/net/wifi/WifiConfiguration;->wepKeyVarNames:[Ljava/lang/String;
    ...
    const-string v28, "failed to set wep_key"
    ...
    const-string v28, "wep_tx_keyidx"
    ...
    const-string v28, "failed to set wep_tx_keyidx: "
    ...
    const-string v28, ": failed to set priority: "
    ...
    const-string v28, ": failed to set hiddenSSID: "
    ...
    invoke-virtual/range {v27 .. v27}, Ljava/util/BitSet;->size()I
    ...
    .line 2866
    const-string v27, "WifiConfigStore"

    const-string v28, "this is WAPI"

    invoke-static/range {v27 .. v28}, Lcom/mediatek/xlog/Xlog;->e(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v28, ": failed to set requirePMF: "
    ...
    const-string v28, "update_identifier"
    ...
    const-string v28, ": failed to set updateIdentifier: "
    ...
    invoke-virtual/range {v27 .. v27}, Landroid/security/KeyStore;->state()Landroid/security/KeyStore$State;

    move-result-object v27

    sget-object v28, Landroid/security/KeyStore$State;->UNLOCKED:Landroid/security/KeyStore$State;
    ...
    const-string v28, ": key store is locked"
    ...
    const-string v28, ": failed to install keys"
    ...
    const-string v28, " invalid config for key installation"
    ...
    const-string v28, ": failed to set "
    ...
    :cond_20
    sget-boolean v27, Lcom/android/server/wifi/WifiConfigStore;->mMtkEapSimAka:Z
    ...
    const-string v29, "failed to set imsi: "
    ...
    const-string v29, "failed to set simSlot: "
    ...
    const-string v29, "failed to set pacFile: "
    ...
    const-string v29, "failed to set phase1: "
    ...
    const-string v28, "created new config netId="
    ...
    const-string v28, "remove deleted status netId="
    ...
    const-string v28, "will read network variables netId="
...
.method private readNetworkHistory()V
    ...
    sget-object v39, Lcom/android/server/wifi/WifiConfigStore;->networkHistoryConfigFile:Ljava/lang/String;
    ...
    .line 1949
    .local v29, "n":Ljava/lang/Integer;
    if-nez v29, :cond_5
    ...
    .end local v29    # "n":Ljava/lang/Integer;
    ...
    .local v22, "ignore":Ljava/io/EOFException;
    ...
    .line 2229
    .end local v22    # "ignore":Ljava/io/EOFException;
    :cond_3
    :goto_2
    if-eqz v23, :cond_4
    ...
    .restart local v29    # "n":Ljava/lang/Integer;
    .restart local v32    # "seen":J
    .restart local v35    # "ssid":Ljava/lang/String;
    ...
    .line 1984
    .local v19, "fqdn":Ljava/lang/String;
    const-string v8, "\n"
    ...
    .line 1988
    .end local v19    # "fqdn":Ljava/lang/String;
    :cond_9
    ...
    .line 1994
    .end local v20    # "gateway":Ljava/lang/String;
    :cond_a
    ...
    .line 1996
    .local v36, "st":Ljava/lang/String;
    const-string v8, "\n"
    ...
    .line 1999
    .local v11, "autojoinstatus":I
    const/16 v8, 0xc8

    if-ne v11, v8, :cond_28

    iget v8, v15, Landroid/net/wifi/WifiConfiguration;->status:I
    ...
    .line 2002
    const-string v8, "readNetworkHistory autojoinstatus delete, config enable"
    ...
    .line 2015
    .end local v11    # "autojoinstatus":I
    .end local v36    # "st":Ljava/lang/String;
    :cond_b
    :goto_5
    ...
    .line 2023
    .local v34, "selfAdded":Ljava/lang/String;
    const-string v8, "\n"
    ...
    .line 2027
    .end local v34    # "selfAdded":Ljava/lang/String;
    :cond_d
    ...
    .line 2029
    .local v17, "didSelfAdd":Ljava/lang/String;
    const-string v8, "\n"
    ...
    .line 2033
    .end local v17    # "didSelfAdd":Ljava/lang/String;
    :cond_e
    ...
    .line 2053
    .local v28, "milli":Ljava/lang/String;
    const-string v8, "\n"
    ...
    .line 2057
    .end local v28    # "milli":Ljava/lang/String;
    :cond_12
    ...
    .line 2065
    .restart local v30    # "num":Ljava/lang/String;
    const-string v8, "\n"
    ...
    const-string v39, "WifiConfigStore: connectChoice:  Couldnt match pattern : "
    ...
    .line 2171
    .local v26, "lvl":Ljava/lang/String;
    const-string v8, "\n"
    ...
    .line 2175
    .end local v26    # "lvl":Ljava/lang/String;
    :cond_22
    ...
    .line 2177
    .restart local v36    # "st":Ljava/lang/String;
    const-string v8, "\n"
    ...
    .line 2003
    .restart local v11    # "autojoinstatus":I
    .restart local v36    # "st":Ljava/lang/String;
    :cond_28
    const/16 v8, 0xc8
    ...
    iget-object v8, v15, Landroid/net/wifi/WifiConfiguration;->preSharedKey:Ljava/lang/String;

    if-eqz v8, :cond_29

    iget-object v8, v15, Landroid/net/wifi/WifiConfiguration;->preSharedKey:Ljava/lang/String;

    const-string v9, "Mjkd86jEMGn79KhKll298Uu7-deleted"
    ...
    const-string v9, "readNetworkHistory autojoinstatus="
    ...
    .end local v35    # "ssid":Ljava/lang/String;
    .end local v37    # "status":I
    .restart local v22    # "ignore":Ljava/io/EOFException;
    .restart local v23    # "in":Ljava/io/DataInputStream;
    :catch_3
    move-exception v18
...
.method loadConfiguredNetworks()V
    ...
    .line 1448
    .local v12, "mOldConfiguredNetworks":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/Integer;Landroid/net/wifi/WifiConfiguration;>;"
    move-object/from16 v0, p0
    ...
    .line 1503
    const-string v19, "Error: get a config with SSID null"
    ...
    .line 1511
    .local v15, "psk":Ljava/lang/String;
    if-eqz v15, :cond_a
    ...
    .line 1516
    :cond_9
    const-string v19, "GOOGLE BUG: should remove because after wpsconnect,there may be 2 config with the same ssid"
    ...
    .local v14, "oldConfig":Landroid/net/wifi/WifiConfiguration;
    if-eqz v14, :cond_c
    ...
    iget v0, v14, Landroid/net/wifi/WifiConfiguration;->autoJoinStatus:I

    move/from16 v19, v0

    move/from16 v0, v19

    iput v0, v4, Landroid/net/wifi/WifiConfiguration;->autoJoinStatus:I

    new-instance v19, Ljava/lang/StringBuilder;

    invoke-direct/range {v19 .. v19}, Ljava/lang/StringBuilder;-><init>()V

    const-string v20, "WifiConfigStore: loadConfiguredNetworks: check autojoinstatus nid = "
    ...
    const-string v19, "discarded duplicate network "
    ...
    const-string v20, "discarded duplicate network orig nid="
    ...
    .end local v4    # "config":Landroid/net/wifi/WifiConfiguration;
    .end local v14    # "oldConfig":Landroid/net/wifi/WifiConfiguration;
    .end local v15    # "psk":Ljava/lang/String;
    ...
    const-string v20, "Mjkd86jEMGn79KhKll298Uu7-deleted"
    ...
    const-string v20, "catch deleted config "
    ...
    :try_start_2
    const-string v19, "--- Begin wpa_supplicant.conf Contents ---"
    ...
    :cond_15
    const-string v19, "--- End wpa_supplicant.conf Contents ---"
...
.method public updateSavedNetworkHistory(Landroid/net/wifi/ScanResult;)Z
    ...
    :cond_9
    iget-object v9, p0, Lcom/android/server/wifi/WifiConfigStore;->mWifiFwkExt:Lcom/mediatek/common/wifi/IWifiFwkExt;

    invoke-interface {v9, v1}, Lcom/mediatek/common/wifi/IWifiFwkExt;->getSecurity(Landroid/net/wifi/WifiConfiguration;)I

    move-result v9

    iget-object v10, p0, Lcom/android/server/wifi/WifiConfigStore;->mWifiFwkExt:Lcom/mediatek/common/wifi/IWifiFwkExt;

    invoke-interface {v10, p1}, Lcom/mediatek/common/wifi/IWifiFwkExt;->getSecurity(Landroid/net/wifi/ScanResult;)I
    ...
    const-string v10, "security method:"
    ...
    invoke-interface {v10, v1}, Lcom/mediatek/common/wifi/IWifiFwkExt;->getSecurity(Landroid/net/wifi/WifiConfiguration;)I
    ...
    new-instance v11, Landroid/net/wifi/ScanResult;

    invoke-direct {v11, p1}, Landroid/net/wifi/ScanResult;-><init>(Landroid/net/wifi/ScanResult;)V
