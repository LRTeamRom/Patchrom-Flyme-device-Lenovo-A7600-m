...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/media/AudioService$Parameter;,
...
.field private static final MSG_HANDLE_DEVICE_CONNECTIOIN:I = 0xcb
...
.field private plugInVolumeChanged:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 165
    iput v6, p0, Landroid/media/AudioService;->storedVolume:I

    .line 166
    iput-boolean v6, p0, Landroid/media/AudioService;->plugInVolumeChanged:Z
...
.method private checkForRingerModeChange(III)I
    ...
    .line 3066
    .local v3, "switchModeWhenVolumeZero":Z
    ...
    const-string v6, "switchModeWhenVolumeZero  "
    ...
    const-string v4, "android.intent.action.RINGTONE_STATE_CHANGED"
    ...
    .line 3140
    :cond_7
    invoke-virtual {p0, v2, v7}, Landroid/media/AudioService;->setRingerMode(IZ)V
...
.method private onSetStreamVolume(IIII)V
    ...
    invoke-direct {p0, v2, p2, p4, v4}, Landroid/media/AudioService;->setStreamVolumeInt(IIIZ)V
    ...
    const-string v2, "android.intent.action.RINGTONE_STATE_CHANGED"
    ...
    invoke-virtual {p0, v1, v4}, Landroid/media/AudioService;->setRingerMode(IZ)V
...
.method private onSetWiredDeviceConnectionState(IILjava/lang/String;)V
    ...
    const-string v7, "onSetWiredDeviceConnectionState:device:"
    ...
    iget v5, v0, Landroid/media/AudioService;->mVolumeControlStream:I
    ...
    iget v0, v0, Landroid/media/AudioService;->mVolumeControlStream:I
    ...
    const-string v7, "getStreamVolume return index:"
    ...
    const-string v6, "before setStreamVolume Music Stream to index 8"
    ...
    invoke-virtual {v0, v5, v6, v7, v8}, Landroid/media/AudioService;->setStreamVolume(IIILjava/lang/String;)V
    ...
    const-string v6, "onSetWiredDeviceConnectionState() no need to setForceUse"
    ...
    .line 4909
    .end local v17    # "isHeadphoneOff":Z
    .end local v18    # "isHeadsetOn":Z
    :cond_4
    move/from16 v0, p1

    and-int/lit16 v5, v0, -0x6001
    ...
    iget-object v15, v0, Landroid/media/AudioService;->mAudioHandler:Landroid/media/AudioService$AudioHandler;
    ...
    new-instance v5, Landroid/media/AudioService$Parameter;
    ...
    invoke-direct/range {v5 .. v10}, Landroid/media/AudioService$Parameter;-><init>(Landroid/media/AudioService;IIZLjava/lang/String;)V
    ...
    invoke-static/range {v10 .. v16}, Landroid/media/AudioService;->sendMsg(Landroid/os/Handler;IIIILjava/lang/Object;I)V
    ...
    iget-object v10, v0, Landroid/media/AudioService;->mAudioHandler:Landroid/media/AudioService$AudioHandler;
    ...
    .line 4940
    :cond_8
    invoke-direct/range {p0 .. p0}, Landroid/media/AudioService;->isPlatformTelevision()Z
    ...
    iput v5, v0, Landroid/media/AudioService;->mFixedVolumeDevices:I

    .line 4942
    invoke-direct/range {p0 .. p0}, Landroid/media/AudioService;->checkAllFixedVolumeDevices()V
    ...
    iput-boolean v5, v0, Landroid/media/AudioService;->mHdmiCecSink:Z
    ...
    iget-object v7, v0, Landroid/media/AudioService;->mHdmiDisplayStatusCallback:Landroid/media/AudioService$MyDisplayStatusCallback;

    invoke-virtual {v5, v7}, Landroid/hardware/hdmi/HdmiPlaybackClient;->queryDisplayStatus(Landroid/hardware/hdmi/HdmiPlaybackClient$DisplayStatusCallback;)V
    ...
    :cond_a
    :try_start_2
    invoke-direct/range {p0 .. p1}, Landroid/media/AudioService;->whetherSmartBookConnected(I)Z
    ...
    const-string v6, "connect smartbook"
    ...
    invoke-direct {v0, v5}, Landroid/media/AudioService;->getActiveStreamType(I)I
    ...
    const-string v6, "before setStreamVolume Ring to index 4"
    ...
    iput v0, v1, Landroid/media/AudioService;->storedVolume:I
    ...
    iput-boolean v5, v0, Landroid/media/AudioService;->plugInVolumeChanged:Z
    ...
    iget v5, v0, Landroid/media/AudioService;->storedVolume:I

    if-eqz v5, :cond_1

    move-object/from16 v0, p0

    iget-boolean v5, v0, Landroid/media/AudioService;->plugInVolumeChanged:Z
    ...
    iget v6, v0, Landroid/media/AudioService;->storedVolume:I
    ...
    .line 4897
    .restart local v19    # "shouldNotify":Z
    :cond_12
    const/16 v17, 0x0
    ...
    const-string v6, "disconnect smartbook"
