...
.method public run()V
    ...
    invoke-static {v2, v3}, Lcom/android/server/media/MediaSessionService;->access$2602(Lcom/android/server/media/MediaSessionService;I)I
    ...
    invoke-static {v2}, Lcom/android/server/media/MediaSessionService;->access$2900(Lcom/android/server/media/MediaSessionService;)I
    ...
    invoke-static {v4}, Lcom/android/server/media/MediaSessionService;->access$2700(Lcom/android/server/media/MediaSessionService;)Lcom/android/server/media/MediaSessionRecord;
    ...
    invoke-static {v2, v0, v3, v4}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->access$3100(Lcom/android/server/media/MediaSessionService$SessionManagerImpl;Landroid/view/KeyEvent;ZLcom/android/server/media/MediaSessionRecord;)V
    ...
    # getter for: Lcom/android/server/media/MediaSessionService;->mHookKeyCode:I
    invoke-static {v3}, Lcom/android/server/media/MediaSessionService;->access$2900(Lcom/android/server/media/MediaSessionService;)I
    ...
    # invokes: Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->dispatchMediaKeyEventLocked(Landroid/view/KeyEvent;ZLcom/android/server/media/MediaSessionRecord;)V
    invoke-static {v2, v1, v3, v4}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->access$3100(Lcom/android/server/media/MediaSessionService$SessionManagerImpl;Landroid/view/KeyEvent;ZLcom/android/server/media/MediaSessionRecord;)V
    ...
    # getter for: Lcom/android/server/media/MediaSessionService;->mHookKeyCode:I
    invoke-static {v4}, Lcom/android/server/media/MediaSessionService;->access$2900(Lcom/android/server/media/MediaSessionService;)I
