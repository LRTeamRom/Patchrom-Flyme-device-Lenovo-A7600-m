...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 993
    new-instance v0, Lcom/android/settings/DateTimeSettings$6;

    invoke-direct {v0}, Lcom/android/settings/DateTimeSettings$6;-><init>()V

    sput-object v0, Lcom/android/settings/DateTimeSettings;->SEARCH_INDEX_DATA_PROVIDER:Lcom/lenovo/settings/search/Indexable$SearchIndexProvider;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/DateTimeSettings;->AUTO_TIME_GPS:Ljava/lang/String;

    .line 897
    new-instance v0, Lcom/android/settings/DateTimeSettings$5;

    invoke-direct {v0, p0}, Lcom/android/settings/DateTimeSettings$5;-><init>(Lcom/android/settings/DateTimeSettings;)V
...
.method static synthetic access$100(Lcom/android/settings/DateTimeSettings;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/DateTimeSettings;

    .prologue
    .line 77
    iget-object v0, p0, Lcom/android/settings/DateTimeSettings;->AUTO_TIME_GPS:Ljava/lang/String;

    return-object v0
.end method

.method static synthetic access$200(Lcom/android/settings/DateTimeSettings;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings/DateTimeSettings;
...
.method private initUI()V
    ...
    iget-object v1, v0, Lcom/android/settings/DateTimeSettings;->AUTO_TIME_GPS:Ljava/lang/String;
...
.method private reSetAutoTimePref()V
    ...
    .line 942
    iget-object v2, p0, Lcom/android/settings/DateTimeSettings;->AUTO_TIME_GPS:Ljava/lang/String;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    .line 926
    iget-object v1, p0, Lcom/android/settings/DateTimeSettings;->AUTO_TIME_GPS:Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/DateTimeSettings;->mInternalRoamingPreferenceCategory:Landroid/preference/PreferenceCategory;
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/settings/DateTimeSettings$1;-><init>(Lcom/android/settings/DateTimeSettings;Landroid/content/Context;Landroid/app/DatePickerDialog$OnDateSetListener;III)V
    ...
    invoke-direct/range {v1 .. v7}, Lcom/android/settings/DateTimeSettings$2;-><init>(Lcom/android/settings/DateTimeSettings;Landroid/content/Context;Landroid/app/TimePickerDialog$OnTimeSetListener;IIZ)V
    ...
    new-instance v4, Lcom/android/settings/DateTimeSettings$3;

    invoke-direct {v4, p0}, Lcom/android/settings/DateTimeSettings$3;-><init>(Lcom/android/settings/DateTimeSettings;)V
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 747
    :cond_3
    iget-object v0, p0, Lcom/android/settings/DateTimeSettings;->mAutoTimeCheck:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v4, p0, Lcom/android/settings/DateTimeSettings;->AUTO_TIME_GPS:Ljava/lang/String;
    ...
    .end local v8    # "autoEnabled":Z
    :cond_8
    iget-object v0, p0, Lcom/android/settings/DateTimeSettings;->mRecommandTimeZone:Landroid/preference/Preference;
    ...
    invoke-virtual {p0, v9}, Lcom/android/settings/DateTimeSettings;->startActivity(Landroid/content/Intent;)V
    ...
    :cond_9
    iget-object v0, p0, Lcom/android/settings/DateTimeSettings;->mTimeDisplay:Landroid/preference/Preference;
...
.method public onResume()V
    ...
    .line 321
    iget-object v5, p0, Lcom/android/settings/DateTimeSettings;->mAutoTimeCheck:Landroid/preference/CheckBoxPreference;
    ...
    .line 324
    :try_start_0
    iget-object v5, p0, Lcom/android/settings/DateTimeSettings;->mAutoTimeZonePref:Landroid/preference/CheckBoxPreference;
    ...
    .line 373
    :goto_1
    iget-object v5, p0, Lcom/android/settings/DateTimeSettings;->mInternalRoamingPreferenceCategory:Landroid/preference/PreferenceCategory;

    invoke-direct {p0}, Lcom/android/settings/DateTimeSettings;->isDualClockShow()Z
    ...
    :goto_2
    iget-object v5, p0, Lcom/android/settings/DateTimeSettings;->mTime24Pref:Landroid/preference/Preference;
    ...
    iget-object v6, p0, Lcom/android/settings/DateTimeSettings;->mIntentReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v6, p0, Lcom/android/settings/DateTimeSettings;->mInternalRoamingPreferenceCategory:Landroid/preference/PreferenceCategory;
    ...
    iput-object v5, p0, Lcom/android/settings/DateTimeSettings;->mAutoTimeCheck:Landroid/preference/CheckBoxPreference;
...
.method public onSharedPreferenceChanged(Landroid/content/SharedPreferences;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/settings/DateTimeSettings;->updateTimeAndDateDisplay(Landroid/content/Context;)V

    .line 508
    invoke-direct/range {p0 .. p0}, Lcom/android/settings/DateTimeSettings;->timeUpdated()V
    ...
    const-class v6, Lcom/android/settings/DateTimeSettings;
    ...
    invoke-direct {v0, v2}, Lcom/android/settings/DateTimeSettings;->getAutoState(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v2}, Lcom/android/settings/DateTimeSettings;->showDialog(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/DateTimeSettings;->setOnCancelListener(Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    iget-object v3, v0, Lcom/android/settings/DateTimeSettings;->mTimePref:Landroid/preference/Preference;
    ...
    iget-object v3, v0, Lcom/android/settings/DateTimeSettings;->mDatePref:Landroid/preference/Preference;
    ...
    iget-object v2, v0, Lcom/android/settings/DateTimeSettings;->AUTO_TIME_GPS:Ljava/lang/String;
    ...
    iget-object v3, v0, Lcom/android/settings/DateTimeSettings;->AUTO_TIME_GPS:Ljava/lang/String;
    ...
    iget-object v3, v0, Lcom/android/settings/DateTimeSettings;->mTimeZone:Landroid/preference/Preference;
