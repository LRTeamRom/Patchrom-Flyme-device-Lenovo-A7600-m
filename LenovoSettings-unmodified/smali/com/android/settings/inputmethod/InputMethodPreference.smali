...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings/inputmethod/InputMethodPreference$SaveImeHandler;
    }
.end annotation
...
.method public constructor <init>(Lcom/android/settings/SettingsPreferenceFragment;Landroid/content/Intent;Landroid/view/inputmethod/InputMethodManager;Landroid/view/inputmethod/InputMethodInfo;)V
    ...
    iput-wide v2, p0, Lcom/android/settings/inputmethod/InputMethodPreference;->lastTonchTime:J
...
.method static synthetic access$000(Lcom/android/settings/inputmethod/InputMethodPreference;)J
    .locals 2
    .param p0, "x0"    # Lcom/android/settings/inputmethod/InputMethodPreference;

    .prologue
    .line 57
    iget-wide v0, p0, Lcom/android/settings/inputmethod/InputMethodPreference;->lastTonchTime:J

    return-wide v0
.end method

.method static synthetic access$002(Lcom/android/settings/inputmethod/InputMethodPreference;J)J
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/inputmethod/InputMethodPreference;
    .param p1, "x1"    # J
    ...
    .prologue
    .line 57
    iput-wide p1, p0, Lcom/android/settings/inputmethod/InputMethodPreference;->lastTonchTime:J
...
.method static synthetic access$100(Lcom/android/settings/inputmethod/InputMethodPreference;)V
    ...
    .prologue
    .line 57
    invoke-direct {p0}, Lcom/android/settings/inputmethod/InputMethodPreference;->onInputMethodPrefClicked()V

    return-void
.end method

.method static synthetic access$200(Lcom/android/settings/inputmethod/InputMethodPreference;)Landroid/content/Intent;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/inputmethod/InputMethodPreference;
...
.method static synthetic access$500(Lcom/android/settings/inputmethod/InputMethodPreference;)Landroid/view/inputmethod/InputMethodInfo;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/inputmethod/InputMethodPreference;
...
.method static synthetic access$700(Lcom/android/settings/inputmethod/InputMethodPreference;ZZ)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings/inputmethod/InputMethodPreference;
    .param p1, "x1"    # Z
    .param p2, "x2"    # Z
...
.method static synthetic access$800(Lcom/android/settings/inputmethod/InputMethodPreference;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings/inputmethod/InputMethodPreference;
...
.method private onInputMethodPrefClicked()V
    ...
    invoke-direct {v0, p0, v2}, Lcom/android/settings/inputmethod/InputMethodPreference$SaveImeHandler;-><init>(Lcom/android/settings/inputmethod/InputMethodPreference;Lcom/android/settings/inputmethod/InputMethodPreference$1;)V

    invoke-virtual {v0, v1, v4, v5}, Lcom/android/settings/inputmethod/InputMethodPreference$SaveImeHandler;->sendEmptyMessageDelayed(IJ)Z
...
.method private showSecurityWarnDialog(Landroid/view/inputmethod/InputMethodInfo;Lcom/android/settings/inputmethod/InputMethodPreference;)V
    ...
    invoke-direct {v2, p0, p2}, Lcom/android/settings/inputmethod/InputMethodPreference$5;-><init>(Lcom/android/settings/inputmethod/InputMethodPreference;Lcom/android/settings/inputmethod/InputMethodPreference;)V
    ...
    invoke-direct {v2, p0, p2}, Lcom/android/settings/inputmethod/InputMethodPreference$4;-><init>(Lcom/android/settings/inputmethod/InputMethodPreference;Lcom/android/settings/inputmethod/InputMethodPreference;)V
...
.method protected onBindView(Landroid/view/View;)V
    ...
    invoke-direct {v2, p0, v1}, Lcom/android/settings/inputmethod/InputMethodPreference$3;-><init>(Lcom/android/settings/inputmethod/InputMethodPreference;Ljava/lang/String;)V
...
.method public startFragment(Landroid/app/Fragment;Ljava/lang/String;ILandroid/os/Bundle;)Z
    ...
    :cond_1
    sget-object v2, Lcom/android/settings/inputmethod/InputMethodPreference;->TAG:Ljava/lang/String;
...
.method public updatePreferenceViews()V
    ...
    invoke-virtual {v5, v6, v7}, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->isAlwaysCheckedIme(Landroid/view/inputmethod/InputMethodInfo;Landroid/content/Context;)Z
    ...
    invoke-virtual {v5, v6}, Lcom/android/settings/inputmethod/InputMethodSettingValuesWrapper;->isInputmethodLatinIME(Landroid/view/inputmethod/InputMethodInfo;)Z
    ...
    .line 232
    .local v0, "checked":Z
    iget-object v5, p0, Lcom/android/settings/inputmethod/InputMethodPreference;->mInputMethodSettingsButton:Landroid/widget/ImageView;
    ...
    .line 240
    :cond_1
    iget-object v5, p0, Lcom/android/settings/inputmethod/InputMethodPreference;->mTitleText:Landroid/widget/TextView;
    ...
    .line 243
    :cond_2
    iget-object v5, p0, Lcom/android/settings/inputmethod/InputMethodPreference;->mSummaryText:Landroid/widget/TextView;
