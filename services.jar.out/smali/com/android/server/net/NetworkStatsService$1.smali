...
.method public getMobileTotalBytes(IJJ)J
    ...
    .line 575
    .local v13, "tele":Landroid/telephony/TelephonyManager;
    if-eqz v13, :cond_4
    ...
    invoke-virtual {v13, v0}, Landroid/telephony/TelephonyManager;->getSimState(I)I
    ...
    .line 585
    :cond_0
    invoke-static {v10, v11}, Lcom/android/server/net/NetworkStatsService;->isValidSubId(J)Z
    ...
    .line 593
    invoke-virtual {v13, v10, v11}, Landroid/telephony/TelephonyManager;->getSubscriberId(J)Ljava/lang/String;
