...
.method public enter()V
    ...
    invoke-static {v3, v4}, Lcom/android/server/wifi/WifiStateMachine;->access$28100(Lcom/android/server/wifi/WifiStateMachine;I)Ljava/lang/String;
    ...
    invoke-static {v5}, Lcom/android/server/wifi/WifiStateMachine;->access$26100(Lcom/android/server/wifi/WifiStateMachine;)Landroid/net/wifi/PPPOEInfo;
    ...
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->mPppoeInfo:Landroid/net/wifi/PPPOEInfo;
    invoke-static {v3}, Lcom/android/server/wifi/WifiStateMachine;->access$26100(Lcom/android/server/wifi/WifiStateMachine;)Landroid/net/wifi/PPPOEInfo;
    ...
    invoke-static {v3, v4, v5}, Lcom/android/server/wifi/WifiStateMachine;->access$28302(Lcom/android/server/wifi/WifiStateMachine;J)J
    ...
    invoke-static {v3, v9, v4}, Lcom/android/server/wifi/WifiStateMachine;->access$27200(Lcom/android/server/wifi/WifiStateMachine;ZI)V
    ...
    invoke-static {v3, v10, v11}, Lcom/android/server/wifi/WifiStateMachine;->access$18002(Lcom/android/server/wifi/WifiStateMachine;J)J
    ...
    invoke-static {v3, v4}, Lcom/android/server/wifi/WifiStateMachine;->access$18402(Lcom/android/server/wifi/WifiStateMachine;Landroid/net/wifi/WifiConfiguration;)Landroid/net/wifi/WifiConfiguration;
    ...
    invoke-static {v3, v8}, Lcom/android/server/wifi/WifiStateMachine;->access$18902(Lcom/android/server/wifi/WifiStateMachine;I)I
    ...
    invoke-static {v3}, Lcom/android/server/wifi/WifiStateMachine;->access$28508(Lcom/android/server/wifi/WifiStateMachine;)I
    ...
    invoke-static {v5}, Lcom/android/server/wifi/WifiStateMachine;->access$28500(Lcom/android/server/wifi/WifiStateMachine;)I
    ...
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->testNetworkDisconnectCounter:I
    invoke-static {v6}, Lcom/android/server/wifi/WifiStateMachine;->access$28500(Lcom/android/server/wifi/WifiStateMachine;)I
    ...
    invoke-static {v3, v10, v11}, Lcom/android/server/wifi/WifiStateMachine;->access$28602(Lcom/android/server/wifi/WifiStateMachine;J)J
    ...
    # setter for: Lcom/android/server/wifi/WifiStateMachine;->mCurrentScanAlarmMs:J
    invoke-static {v3, v10, v11}, Lcom/android/server/wifi/WifiStateMachine;->access$28302(Lcom/android/server/wifi/WifiStateMachine;J)J
...
.method public exit()V
    ...
    # invokes: Lcom/android/server/wifi/WifiStateMachine;->setScanAlarm(ZI)V
    invoke-static {v0, v2, v2}, Lcom/android/server/wifi/WifiStateMachine;->access$27200(Lcom/android/server/wifi/WifiStateMachine;ZI)V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    const-string v21, "Watchdog reports poor link"

    invoke-virtual/range {v20 .. v21}, Lcom/android/server/wifi/WifiStateMachine;->log(Ljava/lang/String;)V
    ...
    invoke-static/range {v20 .. v20}, Lcom/android/server/wifi/WifiStateMachine;->access$700(Lcom/android/server/wifi/WifiStateMachine;)Landroid/os/INetworkManagementService;
    ...
    invoke-static/range {v21 .. v21}, Lcom/android/server/wifi/WifiStateMachine;->access$600(Lcom/android/server/wifi/WifiStateMachine;)Ljava/lang/String;

    move-result-object v21

    invoke-interface/range {v20 .. v21}, Landroid/os/INetworkManagementService;->disableIpv6(Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-static/range {v21 .. v21}, Lcom/android/server/wifi/WifiStateMachine;->access$28700(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/internal/util/State;

    move-result-object v21

    # invokes: Lcom/android/server/wifi/WifiStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static/range {v20 .. v21}, Lcom/android/server/wifi/WifiStateMachine;->access$28800(Lcom/android/server/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
    ...
    const-string v22, "Failed to disable IPv6: "
    ...
    invoke-virtual/range {v20 .. v21}, Lcom/android/server/wifi/WifiStateMachine;->loge(Ljava/lang/String;)V
    ...
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->mWifiConfigStore:Lcom/android/server/wifi/WifiConfigStore;
    invoke-static/range {v20 .. v20}, Lcom/android/server/wifi/WifiStateMachine;->access$6500(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/server/wifi/WifiConfigStore;
    ...
    invoke-virtual/range {v20 .. v22}, Lcom/android/server/wifi/WifiConfigStore;->handleBadNetworkDisconnectReport(ILandroid/net/wifi/WifiInfo;)V
    ...
    invoke-static/range {v20 .. v20}, Lcom/android/server/wifi/WifiStateMachine;->access$3800(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/server/wifi/WifiNative;

    move-result-object v20

    invoke-virtual/range {v20 .. v20}, Lcom/android/server/wifi/WifiNative;->disconnect()Z
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/wifi/WifiStateMachine;->hasCustomizedAutoConnect()Z
    ...
    invoke-static/range {v20 .. v21}, Lcom/android/server/wifi/WifiStateMachine;->access$7602(Lcom/android/server/wifi/WifiStateMachine;Z)Z
    ...
    invoke-static/range {v21 .. v21}, Lcom/android/server/wifi/WifiStateMachine;->access$19200(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/internal/util/State;

    move-result-object v21

    # invokes: Lcom/android/server/wifi/WifiStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static/range {v20 .. v21}, Lcom/android/server/wifi/WifiStateMachine;->access$28900(Lcom/android/server/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/wifi/WifiStateMachine;->getCurrentWifiConfiguration()Landroid/net/wifi/WifiConfiguration;
    ...
    iput-boolean v0, v7, Landroid/net/wifi/WifiConfiguration;->noInternetAccess:Z
    ...
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->testNetworkDisconnectCounter:I
    invoke-static/range {v21 .. v21}, Lcom/android/server/wifi/WifiStateMachine;->access$28500(Lcom/android/server/wifi/WifiStateMachine;)I
    ...
    # setter for: Lcom/android/server/wifi/WifiStateMachine;->mLastDriverRoamAttempt:J
    invoke-static {v0, v1, v2}, Lcom/android/server/wifi/WifiStateMachine;->access$28602(Lcom/android/server/wifi/WifiStateMachine;J)J
    ...
    .line 9084
    .local v19, "toBSSID":Ljava/lang/String;
    if-eqz v19, :cond_5
    ...
    invoke-virtual/range {v20 .. v21}, Lcom/android/server/wifi/WifiConfigStore;->driverRoamedFrom(Landroid/net/wifi/WifiInfo;)V
    ...
    .line 9089
    .end local v19    # "toBSSID":Ljava/lang/String;
    :sswitch_4
    ...
    invoke-static/range {v20 .. v20}, Lcom/android/server/wifi/WifiStateMachine;->access$28600(Lcom/android/server/wifi/WifiStateMachine;)J
    ...
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->mLastDriverRoamAttempt:J
    invoke-static/range {v22 .. v22}, Lcom/android/server/wifi/WifiStateMachine;->access$28600(Lcom/android/server/wifi/WifiStateMachine;)J
    ...
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->mScreenOn:Z
    invoke-static/range {v20 .. v20}, Lcom/android/server/wifi/WifiStateMachine;->access$9600(Lcom/android/server/wifi/WifiStateMachine;)Z
    ...
    invoke-static/range {v20 .. v20}, Lcom/android/server/wifi/WifiStateMachine;->access$17800(Lcom/android/server/wifi/WifiStateMachine;)Z
    ...
    invoke-static/range {v20 .. v20}, Landroid/net/wifi/ScanResult;->is24GHz(I)Z
    ...
    sget v21, Landroid/net/wifi/WifiConfiguration;->BAD_RSSI_24:I
    ...
    invoke-static/range {v20 .. v20}, Landroid/net/wifi/ScanResult;->is5GHz(I)Z
    ...
    sget v21, Landroid/net/wifi/WifiConfiguration;->BAD_RSSI_5:I
    ...
    invoke-virtual/range {v20 .. v22}, Lcom/android/server/wifi/WifiStateMachine;->startScanForConfiguration(Landroid/net/wifi/WifiConfiguration;Z)Z
    ...
    # setter for: Lcom/android/server/wifi/WifiStateMachine;->linkDebouncing:Z
    invoke-static/range {v20 .. v21}, Lcom/android/server/wifi/WifiStateMachine;->access$17802(Lcom/android/server/wifi/WifiStateMachine;Z)Z
    ...
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->mLastNetworkId:I
    invoke-static/range {v24 .. v24}, Lcom/android/server/wifi/WifiStateMachine;->access$6200(Lcom/android/server/wifi/WifiStateMachine;)I

    move-result v24

    invoke-virtual/range {v21 .. v24}, Lcom/android/server/wifi/WifiStateMachine;->obtainMessage(III)Landroid/os/Message;

    move-result-object v21

    const-wide/16 v22, 0x1b58

    invoke-virtual/range {v20 .. v23}, Lcom/android/server/wifi/WifiStateMachine;->sendMessageDelayed(Landroid/os/Message;J)V
    ...
    const-string v22, "NETWORK_DISCONNECTION_EVENT in connected state BSSID="
    ...
    const-string v22, " was debouncing="
    ...
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->linkDebouncing:Z
    invoke-static/range {v22 .. v22}, Lcom/android/server/wifi/WifiStateMachine;->access$17800(Lcom/android/server/wifi/WifiStateMachine;)Z
    ...
    invoke-static/range {v20 .. v20}, Lcom/android/server/wifi/WifiStateMachine;->access$8100(Lcom/android/server/wifi/WifiStateMachine;)Lcom/mediatek/common/wifi/IWifiFwkExt;

    move-result-object v20

    invoke-interface/range {v20 .. v20}, Lcom/mediatek/common/wifi/IWifiFwkExt;->shouldAutoConnect()Z
    ...
    const-string v21, "Skip CMD_AUTO_ROAM for customization!"
    ...
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->mLastNetworkId:I
    invoke-static/range {v20 .. v20}, Lcom/android/server/wifi/WifiStateMachine;->access$6200(Lcom/android/server/wifi/WifiStateMachine;)I
    ...
    const-string v21, "AUTO_ROAM and no config, bail out..."
    ...
    const-string v22, "CMD_AUTO_ROAM sup state "
    ...
    invoke-static/range {v22 .. v22}, Lcom/android/server/wifi/WifiStateMachine;->access$6000(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/server/wifi/SupplicantStateTracker;

    move-result-object v22

    invoke-virtual/range {v22 .. v22}, Lcom/android/server/wifi/SupplicantStateTracker;->getSupplicantStateName()Ljava/lang/String;
    ...
    invoke-static/range {v22 .. v22}, Lcom/android/server/wifi/WifiStateMachine;->access$29000(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/internal/util/IState;
    ...
    const-string v22, " targetRoamBSSID "
    ...
    invoke-static/range {v22 .. v22}, Lcom/android/server/wifi/WifiStateMachine;->access$11700(Lcom/android/server/wifi/WifiStateMachine;)Ljava/lang/String;
    ...
    const-string v21, "AUTO_ROAM nothing to do"
    ...
    invoke-static/range {v20 .. v21}, Lcom/android/server/wifi/WifiStateMachine;->access$2602(Lcom/android/server/wifi/WifiStateMachine;I)I
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/wifi/WifiNative;->reconnect()Z
    ...
    # setter for: Lcom/android/server/wifi/WifiStateMachine;->lastConnectAttempt:J
    invoke-static {v0, v1, v2}, Lcom/android/server/wifi/WifiStateMachine;->access$18002(Lcom/android/server/wifi/WifiStateMachine;J)J
    ...
    # setter for: Lcom/android/server/wifi/WifiStateMachine;->targetWificonfiguration:Landroid/net/wifi/WifiConfiguration;
    invoke-static/range {v20 .. v21}, Lcom/android/server/wifi/WifiStateMachine;->access$18402(Lcom/android/server/wifi/WifiStateMachine;Landroid/net/wifi/WifiConfiguration;)Landroid/net/wifi/WifiConfiguration;
    ...
    # setter for: Lcom/android/server/wifi/WifiStateMachine;->mAutoRoaming:I
    invoke-static/range {v20 .. v21}, Lcom/android/server/wifi/WifiStateMachine;->access$18902(Lcom/android/server/wifi/WifiStateMachine;I)I
    ...
    invoke-static/range {v21 .. v21}, Lcom/android/server/wifi/WifiStateMachine;->access$19000(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/internal/util/State;

    move-result-object v21

    # invokes: Lcom/android/server/wifi/WifiStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static/range {v20 .. v21}, Lcom/android/server/wifi/WifiStateMachine;->access$29100(Lcom/android/server/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/wifi/WifiNative;->reassociate()Z
    ...
    const-string v22, "Failed to connect config: "
    ...
    const-string v21, "Update DNS for pppoe!"
    ...
    invoke-static/range {v20 .. v20}, Lcom/android/server/wifi/WifiStateMachine;->access$29200(Lcom/android/server/wifi/WifiStateMachine;)Landroid/net/LinkProperties;
