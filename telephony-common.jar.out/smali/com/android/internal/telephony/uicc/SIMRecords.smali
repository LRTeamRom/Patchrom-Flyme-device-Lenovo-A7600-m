...
.method public broadcastPhbStateChangedIntent(Z)V
    ...
    const-string v4, "broadcastPhbStateChangedIntent, mPhbReady "
    ...
    const-string v4, ", mSIMInfoReady "

    invoke-virtual {v1, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-boolean v4, p0, Lcom/android/internal/telephony/uicc/SIMRecords;->mSIMInfoReady:Z
    ...
    invoke-virtual {v1}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->getSubId()J
    ...
    .line 3635
    const-string v1, "broadcastPhbStateChangedIntent, subId <= 0"
    ...
    iput-boolean v1, p0, Lcom/android/internal/telephony/uicc/SIMRecords;->mPhbWaitSub:Z
    ...
    const-string v4, "Broadcasting intent ACTION_PHB_STATE_CHANGED "
    ...
    invoke-virtual {v4}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->getSubId()J
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 1101
    .end local v41    # "voiceMailWaiting":Z
    :cond_18
    const/16 v41, 0x0
    ...
    .line 1458
    .local v35, "resource":Landroid/content/res/Resources;
    iget-object v2, v10, Landroid/os/AsyncResult;->exception:Ljava/lang/Throwable;
    ...
    .line 1474
    .end local v10    # "ar":Landroid/os/AsyncResult;
    .end local v35    # "resource":Landroid/content/res/Resources;
    :sswitch_18
    const/16 v24, 0x0
    ...
    .line 1665
    .local v37, "strAllSimState":Ljava/lang/String;
    const-string v38, ""

    .line 1666
    .local v38, "strCurSimState":Ljava/lang/String;
    const/16 v25, 0x0

    .line 1667
    .local v25, "isSimLocked":Z
    move-object/from16 v0, p0
    ...
    aget-object v2, v40, v34

    if-eqz v2, :cond_59

    .line 1674
    aget-object v38, v40, v34
    ...
    .end local v25    # "isSimLocked":Z
    .end local v34    # "phoneId":I
    .end local v37    # "strAllSimState":Ljava/lang/String;
    .end local v38    # "strCurSimState":Ljava/lang/String;
    :sswitch_23
    ...
    .line 1713
    new-instance v29, Lcom/android/internal/telephony/uicc/SIMRecords$RebootClickListener;
    ...
    .line 1715
    .local v29, "listener":Lcom/android/internal/telephony/uicc/SIMRecords$RebootClickListener;
    const/4 v2, 0x0
    ...
    .end local v10    # "ar":Landroid/os/AsyncResult;
    .end local v29    # "listener":Lcom/android/internal/telephony/uicc/SIMRecords$RebootClickListener;
    .end local v36    # "simMelockEvent":[I
    :sswitch_24
    move-object/from16 v0, p1
...
.method public isPhbReady()Z
    ...
    invoke-virtual {v6}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->getSubId()J
...
.method protected onAllRecordsLoaded()V
    ...
    invoke-virtual {v9}, Lcom/android/internal/telephony/SubscriptionController;->getDefaultSmsSubId()J

    move-result-wide v2

    invoke-virtual {v9, v4, v2, v3}, Lcom/android/internal/telephony/SubscriptionController;->setMccMnc(Ljava/lang/String;J)I
    ...
    invoke-virtual {p0, v1, v8}, Lcom/android/internal/telephony/uicc/SIMRecords;->setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v1, "SIMRecords: Corrupt IMSI!"
