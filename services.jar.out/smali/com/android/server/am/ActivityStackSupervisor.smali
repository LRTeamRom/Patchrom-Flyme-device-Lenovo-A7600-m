...
# static fields
.field private static final CABC_MOVE:I = 0x3

.field private static final CABC_OFF:I = 0x0

.field private static final CABC_STILL:I = 0x2

.field private static final CABC_UI:I = 0x1
...
.field mIncallActivityHandler:Landroid/os/Handler;
...
.field mPMLenovo:Landroid/os/PowerManager;
...
.field mWakeupForIncall:Ljava/lang/Runnable;
...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;)V
    ...
    .line 340
    iput-object v3, p0, Lcom/android/server/am/ActivityStackSupervisor;->mPMLenovo:Landroid/os/PowerManager;

    .line 341
    iput-object v3, p0, Lcom/android/server/am/ActivityStackSupervisor;->mIncallActivityHandler:Landroid/os/Handler;
    ...
    iput-object v0, p0, Lcom/android/server/am/ActivityStackSupervisor;->mWakeupForIncall:Ljava/lang/Runnable;

    .line 3094
    const/4 v0, -0x1

    iput v0, p0, Lcom/android/server/am/ActivityStackSupervisor;->mCurrentCABCStates:I
...
.method private displayCameraModeChange(Lcom/android/server/am/ActivityRecord;)V
    .locals 4
    ...
    const-string v0, "com.lenovo.gallery"
    ...
    .line 3105
    :cond_0
    iget v0, p0, Lcom/android/server/am/ActivityStackSupervisor;->mCurrentCABCStates:I

    if-eqz v0, :cond_1

    .line 3106
    invoke-static {v3}, Lcom/lenovo/lcd/LenovoLcdEffectInterface;->setCABC(I)V

    .line 3107
    iput v3, p0, Lcom/android/server/am/ActivityStackSupervisor;->mCurrentCABCStates:I
    ...
    .line 3111
    invoke-static {v2}, Lcom/lenovo/lcd/LenovoLcdEffectInterface;->setCABC(I)V

    .line 3112
    iput v2, p0, Lcom/android/server/am/ActivityStackSupervisor;->mCurrentCABCStates:I
...
.method initPowerManagement()V
    ...
    iput-object v2, p0, Lcom/android/server/am/ActivityStackSupervisor;->mGoingToSleep:Landroid/os/PowerManager$WakeLock;

    .line 363
    const-string v2, "ActivityManager-Launch"

    invoke-virtual {v1, v5, v2}, Landroid/os/PowerManager;->newWakeLock(ILjava/lang/String;)Landroid/os/PowerManager$WakeLock;

    move-result-object v2

    iput-object v2, p0, Lcom/android/server/am/ActivityStackSupervisor;->mLaunchingActivity:Landroid/os/PowerManager$WakeLock;

    .line 365
    iget-object v2, p0, Lcom/android/server/am/ActivityStackSupervisor;->mLaunchingActivity:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v2, p0, Lcom/android/server/am/ActivityStackSupervisor;->mPMLenovo:Landroid/os/PowerManager;
    ...
    iput-object v2, p0, Lcom/android/server/am/ActivityStackSupervisor;->mIncallActivityHandler:Landroid/os/Handler;
...
.method moveHomeStack(Z)V
    ...
    const-string v6, "moveHomeTask: topStack old="
...
.method reportResumedActivityLocked(Lcom/android/server/am/ActivityRecord;)Z
    ...
    .line 3078
    const-string v3, "persist.cabc.disable"
    ...
    .line 3079
    invoke-direct {p0, p1}, Lcom/android/server/am/ActivityStackSupervisor;->displayCameraModeChange(Lcom/android/server/am/ActivityRecord;)V
...
.method resolveActivity(Landroid/content/Intent;Ljava/lang/String;ILandroid/app/ProfilerInfo;I)Landroid/content/pm/ActivityInfo;
    ...
    .line 846
    invoke-interface {v2, v0, p1}, Lcom/android/internal/app/IAppPcService;->checkNetworkPrompt(Landroid/content/pm/ActivityInfo;Landroid/content/Intent;)Landroid/content/pm/ActivityInfo;
    :try_end_1
    ...
    .line 857
    .end local v2    # "mAppPcService":Lcom/android/internal/app/IAppPcService;
    :cond_0
    :goto_1
    ...
    const-string v5, "init AppPcService"
...
.method final startActivityMayWait(Landroid/app/IApplicationThread;ILjava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;Landroid/os/IBinder;Ljava/lang/String;IILandroid/app/ProfilerInfo;Landroid/app/IActivityManager$WaitResult;Landroid/content/res/Configuration;Landroid/os/Bundle;ILandroid/app/IActivityContainer;Lcom/android/server/am/TaskRecord;)I
    ...
    const-string v7, "startActivity now"
    ...
    invoke-static {v5, v0, v4, v1}, Lcom/mediatek/common/mom/MobileManagerUtils;->checkIntentPermission(Landroid/content/Intent;Landroid/content/pm/ActivityInfo;Landroid/content/Context;I)Z
    ...
    const-string v7, "startActivity() is not granted with permission: "
    ...
    .line 926
    .local v33, "categories":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    ...
    .line 944
    .local v48, "type":I
    new-instance v47, Lcom/android/server/am/ActivityStackSupervisor$2;
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/android/server/am/ActivityStackSupervisor$2;-><init>(Lcom/android/server/am/ActivityStackSupervisor;Ljava/lang/String;I)V

    .line 949
    .local v47, "thread":Ljava/lang/Thread;
    invoke-virtual/range {v47 .. v47}, Ljava/lang/Thread;->start()V

    .end local v33    # "categories":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    .end local v35    # "flags":I
    .end local v40    # "packageName":Ljava/lang/String;
    .end local v45    # "startType":I
...
.method final startActivityUncheckedLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;IZLandroid/os/Bundle;Lcom/android/server/am/TaskRecord;)I
    ...
    iget-object v4, v0, Lcom/android/server/am/ActivityStackSupervisor;->mIncallActivityHandler:Landroid/os/Handler;

    move-object/from16 v0, p0

    iget-object v5, v0, Lcom/android/server/am/ActivityStackSupervisor;->mWakeupForIncall:Ljava/lang/Runnable;
    ...
    const-string v5, "post wakeup incall"
