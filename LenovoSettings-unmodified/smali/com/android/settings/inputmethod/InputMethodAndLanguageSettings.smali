...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;->SEARCH_INDEX_DATA_PROVIDER:Lcom/lenovo/settings/search/Indexable$SearchIndexProvider;
...
.method static synthetic access$100(Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;Landroid/hardware/input/InputDeviceIdentifier;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;
...
.method private updateInputMethodPreferenceViews()V
    ...
    .prologue
    .line 478
    iget-object v9, p0, Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;->mInputMethodPreferenceList:Ljava/util/ArrayList;
    ...
    .line 481
    .local v6, "imp":Lcom/android/settings/inputmethod/InputMethodPreference;
    ...
    .end local v6    # "imp":Lcom/android/settings/inputmethod/InputMethodPreference;
    :catchall_0
    move-exception v8
    ...
    invoke-direct {p0, v4}, Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;->getInputMethodPreference(Landroid/view/inputmethod/InputMethodInfo;)Lcom/android/settings/inputmethod/InputMethodPreference;

    move-result-object v7

    .line 491
    .local v7, "pref":Lcom/android/settings/inputmethod/InputMethodPreference;
    iget-object v8, p0, Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;->mOnImePreferenceChangedListener:Landroid/preference/Preference$OnPreferenceChangeListener;

    invoke-virtual {v7, v8}, Lcom/android/settings/inputmethod/InputMethodPreference;->setOnImePreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V
    ...
    .end local v7    # "pref":Lcom/android/settings/inputmethod/InputMethodPreference;
    :cond_1
    :try_start_3
    ...
    check-cast v7, Lcom/android/settings/inputmethod/InputMethodPreference;

    .line 509
    .local v7, "pref":Landroid/preference/Preference;
    instance-of v8, v7, Lcom/android/settings/inputmethod/InputMethodPreference;
    ...
    invoke-virtual {v7}, Lcom/android/settings/inputmethod/InputMethodPreference;->updatePreferenceViews()V
    ...
    invoke-static {p0, v8, v9, v10}, Lcom/android/settings/inputmethod/InputMethodAndSubtypeUtil;->loadInputMethodSubtypeList(Lcom/android/settings/SettingsPreferenceFragment;Landroid/content/ContentResolver;Ljava/util/List;Ljava/util/Map;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    check-cast v11, Lcom/android/settings/inputmethod/SpellCheckersPreference;

    .line 213
    .local v11, "scp":Lcom/android/settings/inputmethod/SpellCheckersPreference;
    if-eqz v11, :cond_2

    .line 214
    invoke-virtual {v11, p0, v9}, Lcom/android/settings/inputmethod/SpellCheckersPreference;->setFragmentIntent(Lcom/android/settings/SettingsPreferenceFragment;Landroid/content/Intent;)V
    ...
    .end local v11    # "scp":Lcom/android/settings/inputmethod/SpellCheckersPreference;
...
.method public onPause()V
    ...
    :goto_0
    invoke-static {p0, v2, v3, v1}, Lcom/android/settings/inputmethod/InputMethodAndSubtypeUtil;->saveInputMethodSubtypeList(Lcom/android/settings/SettingsPreferenceFragment;Landroid/content/ContentResolver;Ljava/util/List;Z)V
...
.method public onResume()V
    ...
    invoke-direct {p0, v6}, Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;->getDisplayName(Ljava/util/Locale;)Ljava/lang/String;
