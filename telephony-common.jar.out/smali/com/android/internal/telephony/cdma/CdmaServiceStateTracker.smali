...
.method private regCodeIsRoaming(I)Z
    ...
    .line 1839
    invoke-static {v4}, Lcom/mediatek/internal/telephony/cdma/PlusCodeToIddNddUtils;->checkMccBySidLtmOff(Ljava/lang/String;)Ljava/lang/String;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-interface {v4, v15, v0}, Lcom/android/internal/telephony/CommandsInterface;->setPreferredNetworkType(ILandroid/os/Message;)V
    ...
    const-string v25, "EVENT_RUIM_READY isSubscriptionFromRuim"
    ...
    const-string v25, "EVENT_NV_READY isSubscriptionFromRuim"
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/internal/telephony/cdma/CDMAPhone;->getPhoneId()I
    ...
    const-string v26, "EVENT_GET_NITZ_TIME ignore: isOn()="
    ...
    const-string v26, ", mRegistrationState="
    ...
    const-string v26, "EVENT_GET_NITZ_TIME: "
    ...
    aget-object v21, v4, v25

    check-cast v21, Ljava/lang/String;

    .line 506
    .local v21, "nitzStringSolicite":Ljava/lang/String;
    iget-object v4, v10, Landroid/os/AsyncResult;->result:Ljava/lang/Object;
    ...
    const-string v26, "EVENT_GET_NITZ_TIME  nitzStringSolicite = "
    ...
    const-string v26, "nitzReceiveTimeSolicite = "
    ...
    .end local v21    # "nitzStringSolicite":Ljava/lang/String;
    :sswitch_7
    move-object/from16 v0, p1
    ...
    const-string v25, "sendToTarget msg ="
    ...
    const-string v25, " mCdmaNetWorkMode = "
...
.method protected handlePollStateResultMessage(ILandroid/os/AsyncResult;)V
    ...
    const-string v9, "handlePollStateResultMessage: EVENT_POLL_STATE_GPRS states.length="
    ...
    .line 957
    .local v16, "dataRadioTechnology":I
    move-object/from16 v0, v28
    ...
    const-string v9, "handlPollStateResultMessage: cdma setDataRegState="
    ...
    const-string v9, "handlePollStateResultMessage: error parsing GprsRegistrationState: "
    ...
    .line 983
    .end local v16    # "dataRadioTechnology":I
    ...
    .line 998
    .local v18, "defaultRoamingIndicator":I
    const/16 v24, 0x0
    ...
    iput-object v2, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mSid:Ljava/lang/String;
    ...
    const-string v9, "handlePollStateResultMessage: mSid="
    ...
    iget-object v9, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mSid:Ljava/lang/String;
    ...
    iput-object v2, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mNid:Ljava/lang/String;
    ...
    const-string v9, "handlePollStateResultMessage: mNid="
    ...
    iget-object v9, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mNid:Ljava/lang/String;
    ...
    invoke-virtual {v2, v9}, Landroid/telephony/ServiceState;->setState(I)V

    .line 1069
    move-object/from16 v0, p0

    iget-boolean v2, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mCdmaRoaming:Z
    ...
    invoke-virtual {v2, v9}, Landroid/telephony/ServiceState;->setRegState(I)V
    ...
    const-string v9, "mNewSS.getRegState()="
    ...
    iget-object v9, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mNewSS:Landroid/telephony/ServiceState;

    invoke-virtual {v9}, Landroid/telephony/ServiceState;->getRegState()I
    ...
    .line 1080
    const-string v2, "newSS.setCdmaNetworkMode;"
    ...
    iget v9, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mCdmaNetWorkMode:I

    invoke-virtual {v2, v9}, Landroid/telephony/ServiceState;->setCdmaNetworkMode(I)V
    ...
    invoke-virtual {v2, v15}, Landroid/telephony/ServiceState;->setCssIndicator(I)V
    ...
    const-string v9, "setSystemProperty(cdma.operator.sid)="
    ...
    .line 1092
    const-string v2, "cdma.operator.sid"
    ...
    iget-object v2, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mNewCellLoc:Landroid/telephony/cdma/CdmaCellLocation;
    ...
    const-string v9, "Registration denied, "
    ...
    iget-object v9, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mRegistrationDeniedReason:Ljava/lang/String;
    ...
    .line 1051
    .restart local v26    # "registrationState":I
    :catch_1
    move-exception v19

    .line 1052
    .restart local v19    # "ex":Ljava/lang/NumberFormatException;
    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v9, "EVENT_POLL_STATE_REGISTRATION_CDMA: error parsing: "
    ...
    const-string v10, "Warning! Wrong number of parameters returned from RIL_REQUEST_REGISTRATION_STATE: expected 14 or more strings and got "
    ...
    invoke-virtual {v2, v0}, Landroid/telephony/ServiceState;->setRegState(I)V
    ...
    .end local v15    # "cssIndicator":I
    .end local v18    # "defaultRoamingIndicator":I
    ...
    const-string v9, "RIL_REQUEST_OPERATOR.response[2], the numeric,  is bad. Using SystemProperties \'"
    ...
    const-string v9, "RIL_REQUEST_OPERATOR.opNames[0], "
    ...
    .line 1145
    invoke-static {v12}, Lcom/mediatek/internal/telephony/cdma/PlusCodeToIddNddUtils;->checkMccBySidLtmOff(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v9, "the result of checkMccBySidLtmOff: numeric ="
    ...
    invoke-virtual {v10}, Lcom/android/internal/telephony/cdma/CDMAPhone;->getSubId()J
    ...
    invoke-virtual/range {v9 .. v14}, Lcom/android/internal/telephony/uicc/SpnOverride;->lookupOperatorName(JLjava/lang/String;ZLandroid/content/Context;)Ljava/lang/String;
    ...
    iget-boolean v2, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mIsSubscriptionFromRuim:Z
    ...
    invoke-virtual {v2, v9, v10, v11}, Landroid/telephony/ServiceState;->setOperatorName(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v9, "for MCC = (1111), setSystemProperty(cdma.operator.mcc) = "
    ...
    .line 1180
    const-string v2, "cdma.operator.mcc"
    ...
    const-string v9, "broadcast android.intent.action.MCC_MNC_CHANGED:"
    ...
    const-string v2, "android.intent.action.MCC_MNC_CHANGED"
    ...
    iget-object v2, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mUiccController:Lcom/android/internal/telephony/uicc/UiccController;
    ...
    .line 1164
    .local v8, "brandOverride":Ljava/lang/String;
    :goto_9
    if-eqz v8, :cond_1c
    ...
    invoke-virtual {v2, v8, v8, v9}, Landroid/telephony/ServiceState;->setOperatorName(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    goto/16 :goto_7

    .line 1162
    .end local v8    # "brandOverride":Ljava/lang/String;
    :cond_1b
    const/4 v8, 0x0
    ...
    .line 1167
    .restart local v8    # "brandOverride":Ljava/lang/String;
    :cond_1c
    move-object/from16 v0, p0
    ...
    const-string v9, "setSystemProperty(cdma.operator.mcc) = "
...
.method protected pollStateDone()V
    ...
    invoke-virtual/range {v27 .. v27}, Landroid/telephony/ServiceState;->getRegState()I
    ...
    invoke-virtual/range {v28 .. v28}, Landroid/telephony/ServiceState;->getRegState()I
    ...
    .line 1497
    .local v13, "hasRegStateChanged":Z
    :goto_b
    new-instance v27, Ljava/lang/StringBuilder;

    invoke-direct/range {v27 .. v27}, Ljava/lang/StringBuilder;-><init>()V

    const-string v28, "pollStateDone: hasRegStateChanged = "
    ...
    const-string v28, "pollStateDone: mInService = "
    ...
    const-string v28, "pollStateDone isSubscriptionFromRuim = "
    ...
    invoke-virtual/range {v27 .. v27}, Lcom/android/internal/telephony/cdma/CDMAPhone;->getServiceState()Landroid/telephony/ServiceState;
    ...
    invoke-virtual/range {v27 .. v27}, Landroid/telephony/ServiceState;->setStateOff()V
    ...
    .end local v13    # "hasRegStateChanged":Z
    ...
    .line 1512
    .restart local v13    # "hasRegStateChanged":Z
    :cond_1f
    const/16 v27, 0x0
...
.method protected updateSpnDisplay(Z)V
    ...
    invoke-static {v1, v8}, Landroid/telephony/SubscriptionManager;->putPhoneIdAndSubIdExtra(Landroid/content/Intent;I)V
