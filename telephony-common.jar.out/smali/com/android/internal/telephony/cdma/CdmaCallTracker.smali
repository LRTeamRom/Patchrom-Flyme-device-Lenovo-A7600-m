...
.method private checkMtFindNewRinging(Lcom/android/internal/telephony/DriverCall;I)Lcom/android/internal/telephony/Connection;
    ...
    invoke-virtual {v6}, Lcom/android/internal/telephony/cdma/CDMAPhone;->getSubId()J
...
.method private handleCallWaitingInfo(Lcom/android/internal/telephony/cdma/CdmaCallWaitingNotification;)V
    ...
    .line 1060
    invoke-static {v6}, Lcom/android/internal/telephony/cdma/PlusCodeToIddNddUtils;->removeIddNddAddPlusCode(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/internal/telephony/cdma/CDMAPhone;->getSubId()J
    ...
    invoke-virtual {v15}, Lcom/android/internal/telephony/cdma/CdmaConnection;->getCreateTime()J
    ...
    invoke-virtual {v0, v15}, Lcom/android/internal/telephony/cdma/CdmaCall;->detach(Lcom/android/internal/telephony/cdma/CdmaConnection;)V

    .line 1129
    const-string v19, "CdmaCallTracker"

    const-string v20, "handleCallWaitingInfo detach last RingConn"
...
.method dial(Ljava/lang/String;I)Lcom/android/internal/telephony/Connection;
    ...
    invoke-static {p1, v8}, Landroid/telephony/PhoneNumberUtils;->isEmergencyNumberExt(Ljava/lang/String;I)Z
    ...
    const-string v9, "send EVENT_CDMA_DIAL_THREEWAY_DELAY"
    ...
    const-string v9, "exit emergency callback mode when dial threeway"
    ...
    invoke-virtual {v8, p0, v9, p1}, Lcom/android/internal/telephony/cdma/CDMAPhone;->setOnThreeWayEcmExitResponse(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-virtual {v8, v6}, Lcom/android/internal/telephony/cdma/CdmaConnection;->setConverted(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v8}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->formatDialNumber(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v8, v0, p2, v9}, Lcom/android/internal/telephony/CommandsInterface;->dial(Ljava/lang/String;ILandroid/os/Message;)V
...
.method protected handlePollCalls(Landroid/os/AsyncResult;)V
    ...
    const-string v25, "before format number = "
    ...
    invoke-static/range {v24 .. v24}, Lcom/android/internal/telephony/cdma/PlusCodeToIddNddUtils;->removeIddNddAddPlusCode(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v25, "after format number = "
    ...
    invoke-static/range {v24 .. v25}, Landroid/telephony/PhoneNumberUtils;->stringFromStringAndTOA(Ljava/lang/String;I)Ljava/lang/String;
    ...
    :cond_1
    :goto_2
    const-string v24, "ril.cdma.inecmmode"
    ...
    invoke-virtual/range {v24 .. v24}, Lcom/android/internal/telephony/cdma/CdmaConnection;->getOrigDialString()Ljava/lang/String;

    move-result-object v24

    const/16 v25, 0x2

    invoke-static/range {v24 .. v25}, Landroid/telephony/PhoneNumberUtils;->isEmergencyNumberExt(Ljava/lang/String;I)Z
    ...
    .end local v17    # "isPhoneInEcmMode":Z
    ...
    .restart local v17    # "isPhoneInEcmMode":Z
    :catch_0
    move-exception v12
    ...
    invoke-virtual/range {v24 .. v24}, Lcom/android/internal/telephony/cdma/CDMAPhone;->getImsPhone()Lcom/android/internal/telephony/Phone;

    move-result-object v24

    check-cast v24, Lcom/android/internal/telephony/PhoneBase;
    ...
    invoke-virtual/range {v24 .. v25}, Lcom/android/internal/telephony/cdma/CdmaConnection;->migrateFrom(Lcom/android/internal/telephony/Connection;)V
    ...
    invoke-virtual/range {v24 .. v26}, Lcom/android/internal/telephony/cdma/CDMAPhone;->notifyHandoverStateChanged(Lcom/android/internal/telephony/Connection;Lcom/android/internal/telephony/Connection;)V
