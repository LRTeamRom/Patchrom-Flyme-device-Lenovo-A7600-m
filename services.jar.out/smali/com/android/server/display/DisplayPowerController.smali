...
.method public constructor <init>(Landroid/content/Context;Landroid/hardware/display/DisplayManagerInternal$DisplayPowerCallbacks;Landroid/os/Handler;Landroid/hardware/SensorManager;Lcom/android/server/display/DisplayBlanker;)V
    ...
    invoke-static {v13, v2, v11, v3, v4}, Ljava/lang/System;->arraycopy([II[III)V
    ...
    invoke-static {v15, v2, v11, v3, v4}, Ljava/lang/System;->arraycopy([II[III)V

    .line 368
    move-object/from16 v0, p0

    iput-object v11, v0, Lcom/android/server/display/DisplayPowerController;->mTuningInitCurve:[I
...
.method static synthetic access$1400(Lcom/android/server/display/DisplayPowerController;)F
    .locals 1
    .param p0, "x0"    # Lcom/android/server/display/DisplayPowerController;
...
.method static synthetic access$1500(Lcom/android/server/display/DisplayPowerController;JZ)V
    .locals 1
    .param p0, "x0"    # Lcom/android/server/display/DisplayPowerController;
    .param p1, "x1"    # J
    .param p3, "x2"    # Z
...
.method static synthetic access$1600(Lcom/android/server/display/DisplayPowerController;)Lcom/android/server/display/DisplayPowerController$DisplayControllerHandler;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/display/DisplayPowerController;
...
.method private updatePowerState()V
    ...
    .line 589
    sget-boolean v12, Lcom/android/server/display/DisplayPowerController;->MTK_AAL_RUNTIME_TUNING_SUPPORT:Z

    if-eqz v12, :cond_3

    .line 590
    invoke-direct {p0}, Lcom/android/server/display/DisplayPowerController;->writeInitConfig()V
    ...
    .line 594
    invoke-direct {p0}, Lcom/android/server/display/DisplayPowerController;->updateRuntimeConfig()V
    ...
    iget-boolean v12, p0, Lcom/android/server/display/DisplayPowerController;->mShutDown:Z
    ...
    iput-boolean v12, p0, Lcom/android/server/display/DisplayPowerController;->mShutDown:Z

    goto :goto_4

    .line 608
    :cond_9
    iget-boolean v12, p0, Lcom/android/server/display/DisplayPowerController;->mIPOShutDown:Z
    ...
    .line 674
    .local v4, "ipoShutdown":Z
    invoke-direct {p0, v11, v7}, Lcom/android/server/display/DisplayPowerController;->animateScreenStateChange(IZ)V
    ...
    invoke-virtual {v12, v1, v13}, Lcom/android/server/display/AutomaticBrightnessController;->configure(ZF)V
    ...
    .line 776
    .local v8, "rate":I
    sget-boolean v12, Lcom/android/server/display/DisplayPowerController;->MTK_AAL_SUPPORT:Z

    if-eqz v12, :cond_1f

    .line 777
    iget-boolean v12, p0, Lcom/android/server/display/DisplayPowerController;->mTuningQuicklyApply:Z
    ...
    invoke-virtual {v12}, Lcom/android/server/display/DisplayPowerState;->getScreenBrightness()I
    ...
    .line 781
    iget v8, p0, Lcom/android/server/display/DisplayPowerController;->BRIGHTNESS_RAMP_RATE_BRIGHTEN:I
    ...
    invoke-direct {p0, v2, v12}, Lcom/android/server/display/DisplayPowerController;->animateScreenBrightness(II)V
    ...
    .restart local v4    # "ipoShutdown":Z
    :cond_2b
    const/4 v1, 0x0
    ...
    :cond_30
    iget v8, p0, Lcom/android/server/display/DisplayPowerController;->BRIGHTNESS_RAMP_RATE_DARKEN:I

    goto/16 :goto_d

    .line 793
    :cond_31
    invoke-direct {p0, v2, v8}, Lcom/android/server/display/DisplayPowerController;->animateScreenBrightness(II)V
...
.method private updateRuntimeConfig()V
    ...
    .line 1397
    invoke-static {v5, v0}, Lcom/android/server/display/DisplayPowerController;->createAutoBrightnessSpline([I[I)Landroid/util/Spline;
