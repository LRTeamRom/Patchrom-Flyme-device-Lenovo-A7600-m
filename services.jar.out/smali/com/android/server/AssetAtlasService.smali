...
.field private static final ATLAS_PROGRAM_MAP_ENTRY_FIELD_COUNT:I = 0x4
...
.field private final mProgramBinariesReady:Ljava/util/concurrent/atomic/AtomicBoolean;

.field private mProgramMap:[J
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v7, p0, Lcom/android/server/AssetAtlasService;->mProgramBinariesReady:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    const-string v7, "AssetAtlasService"

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string v9, "AssetAtlasService: size of preload drawables is "
...
.method static synthetic access$1002(Lcom/android/server/AssetAtlasService;I)I
    .locals 0
    .param p0, "x0"    # Lcom/android/server/AssetAtlasService;
    .param p1, "x1"    # I
    ...
    .prologue
    .line 72
    iput p1, p0, Lcom/android/server/AssetAtlasService;->mBinaryLength:I

    return p1
.end method

.method static synthetic access$1100(Lcom/android/server/AssetAtlasService;)Ljava/util/concurrent/atomic/AtomicBoolean;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/AssetAtlasService;

    .prologue
    .line 72
    iget-object v0, p0, Lcom/android/server/AssetAtlasService;->mProgramBinariesReady:Ljava/util/concurrent/atomic/AtomicBoolean;

    return-object v0
.end method

.method static synthetic access$1200(Landroid/graphics/Canvas;II)J
    .locals 2
...
.method static synthetic access$1300(Landroid/graphics/Canvas;J)V
    .locals 1
    .param p0, "x0"    # Landroid/graphics/Canvas;
    .param p1, "x1"    # J
...
.method static synthetic access$700(Ljava/io/FileDescriptor;[I[J[I)Z
    .locals 1
    ...
    .prologue
    .line 72
    invoke-static {p0, p1, p2, p3}, Lcom/android/server/AssetAtlasService;->nBuildProgramBinaries(Ljava/io/FileDescriptor;[I[J[I)Z
...
.method static synthetic access$802(Lcom/android/server/AssetAtlasService;Ljava/io/FileDescriptor;)Ljava/io/FileDescriptor;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/AssetAtlasService;
    ...
    .prologue
    .line 72
    iput-object p1, p0, Lcom/android/server/AssetAtlasService;->mFD:Ljava/io/FileDescriptor;

    return-object p1
.end method

.method static synthetic access$900(Lcom/android/server/AssetAtlasService;)[J
    .locals 1
    .param p0, "x0"    # Lcom/android/server/AssetAtlasService;

    .prologue
    .line 72
    iget-object v0, p0, Lcom/android/server/AssetAtlasService;->mProgramMap:[J

    return-object v0
.end method

.method static synthetic access$902(Lcom/android/server/AssetAtlasService;[J)[J
    .locals 0
    .param p0, "x0"    # Lcom/android/server/AssetAtlasService;
    .param p1, "x1"    # [J
    ...
    .prologue
    .line 72
    iput-object p1, p0, Lcom/android/server/AssetAtlasService;->mProgramMap:[J
...
.method private static native nBuildProgramBinaries(Ljava/io/FileDescriptor;[I[J[I)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method private static native nReleaseFileDescriptor(Ljava/io/FileDescriptor;)V
.end method
...
.method protected finalize()V
    ...
    .line 487
    iget-object v0, p0, Lcom/android/server/AssetAtlasService;->mFD:Ljava/io/FileDescriptor;

    invoke-static {v0}, Lcom/android/server/AssetAtlasService;->nReleaseFileDescriptor(Ljava/io/FileDescriptor;)V

    .line 488
    iput-object v1, p0, Lcom/android/server/AssetAtlasService;->mFD:Ljava/io/FileDescriptor;

    .line 489
    iput-object v1, p0, Lcom/android/server/AssetAtlasService;->mProgramMap:[J

    .line 490
    const/4 v0, 0x0

    iput v0, p0, Lcom/android/server/AssetAtlasService;->mBinaryLength:I
...
.method public getProgramFd()Landroid/os/ParcelFileDescriptor;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    .prologue
    .line 464
    iget-object v1, p0, Lcom/android/server/AssetAtlasService;->mProgramBinariesReady:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 466
    :try_start_0
    iget-object v1, p0, Lcom/android/server/AssetAtlasService;->mFD:Ljava/io/FileDescriptor;
    ...
    .line 468
    .local v0, "e":Ljava/io/IOException;
    const-string v1, "AssetAtlasService"

    const-string v2, "Could not get the file descriptor of proram binary"
...
.method public getProgramLength()I
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    iget v0, p0, Lcom/android/server/AssetAtlasService;->mBinaryLength:I
