...
.method public refresh()V
    ...
    iget-object v9, p0, Lcom/flyme/deviceoriginalsettings/nfc/PaymentSettings;->mPaymentBackend:Lcom/flyme/deviceoriginalsettings/nfc/PaymentBackend;

    invoke-virtual {v9}, Lcom/flyme/deviceoriginalsettings/nfc/PaymentBackend;->getPaymentAppInfos()Ljava/util/List;
    ...
    .line 75
    .local v0, "appInfo":Lcom/flyme/deviceoriginalsettings/nfc/PaymentBackend$PaymentAppInfo;
    new-instance v7, Lcom/flyme/deviceoriginalsettings/nfc/PaymentSettings$PaymentAppPreference;

    invoke-virtual {p0}, Lcom/flyme/deviceoriginalsettings/nfc/PaymentSettings;->getActivity()Landroid/app/Activity;

    move-result-object v9

    invoke-direct {v7, v9, v0, p0}, Lcom/flyme/deviceoriginalsettings/nfc/PaymentSettings$PaymentAppPreference;-><init>(Landroid/content/Context;Lcom/flyme/deviceoriginalsettings/nfc/PaymentBackend$PaymentAppInfo;Landroid/view/View$OnClickListener;)V

    .line 77
    .local v7, "preference":Lcom/flyme/deviceoriginalsettings/nfc/PaymentSettings$PaymentAppPreference;
    iget-object v9, v0, Lcom/flyme/deviceoriginalsettings/nfc/PaymentBackend$PaymentAppInfo;->caption:Ljava/lang/CharSequence;

    invoke-virtual {v7, v9}, Lcom/flyme/deviceoriginalsettings/nfc/PaymentSettings$PaymentAppPreference;->setTitle(Ljava/lang/CharSequence;)V

    .line 78
    iget-object v9, v0, Lcom/flyme/deviceoriginalsettings/nfc/PaymentBackend$PaymentAppInfo;->banner:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v11, v0, Lcom/flyme/deviceoriginalsettings/nfc/PaymentBackend$PaymentAppInfo;->componentName:Landroid/content/ComponentName;
    ...
    .end local v7    # "preference":Lcom/flyme/deviceoriginalsettings/nfc/PaymentSettings$PaymentAppPreference;
    :cond_1
    invoke-virtual {p0}, Lcom/flyme/deviceoriginalsettings/nfc/PaymentSettings;->getView()Landroid/view/View;

    move-result-object v9

    const v10, 0x7f0e019e
    ...
    .line 100
    :goto_1
    invoke-virtual {p0, v8}, Lcom/flyme/deviceoriginalsettings/nfc/PaymentSettings;->setPreferenceScreen(Landroid/preference/PreferenceScreen;)V
