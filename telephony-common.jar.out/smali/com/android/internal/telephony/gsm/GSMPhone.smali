...
.field private static final TERMINAL_BASED_CALL_WAITING_DISABLED:Ljava/lang/String; = "disabled_tbcw"

.field private static final TERMINAL_BASED_CALL_WAITING_ENABLED_OFF:Ljava/lang/String; = "enabled_tbcw_off"

.field private static final TERMINAL_BASED_CALL_WAITING_ENABLED_ON:Ljava/lang/String; = "enabled_tbcw_on"
...
.method static synthetic access$002(Lcom/android/internal/telephony/gsm/GSMPhone;Z)Z
    .locals 0
...
.method private onIncomingUSSD(ILjava/lang/String;)V
    ...
    const-string v10, "isUssdRequest="
    ...
    const-string v10, "USSD:mPendingMMIs= "
    ...
    const-string v9, "setUserInitiatedMMI  TRUE"

    invoke-static {v7, v9}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1703
    invoke-virtual {v0, v8}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->setUserInitiatedMMI(Z)V
    ...
    .end local v4    # "isUssdhandleByStk":Z
    .end local v6    # "s":I
    :cond_4
    move v3, v4
    ...
    .restart local v4    # "isUssdhandleByStk":Z
    ...
    .line 1708
    invoke-virtual {v0, p2, v3}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->onUssdStkHandling(Ljava/lang/String;Z)V
    ...
    const-string v8, "The default value of UserInitiatedMMI is FALSE"
    ...
    invoke-static {p2, v3, p0, v7}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->newNetworkInitiatedUssd(Ljava/lang/String;ZLcom/android/internal/telephony/gsm/GSMPhone;Lcom/android/internal/telephony/uicc/UiccCardApplication;)Lcom/android/internal/telephony/gsm/GsmMmiCode;
    ...
    invoke-static {p2, v3, p0, v7}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->newNetworkInitiatedUssdError(Ljava/lang/String;ZLcom/android/internal/telephony/gsm/GSMPhone;Lcom/android/internal/telephony/uicc/UiccCardApplication;)Lcom/android/internal/telephony/gsm/GsmMmiCode;
...
.method public dispose()V
    ...
    const-string v2, "GSMPhone:dispose: clear mPendingMMIs"
...
.method public getCallWaiting(Landroid/os/Message;)V
    ...
    const-string v4, "disabled_tbcw"

    invoke-virtual {p0, v3, v4}, Lcom/android/internal/telephony/gsm/GSMPhone;->getSystemProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    .line 1414
    .local v2, "tbcwMode":Ljava/lang/String;
    const-string v3, "GSMPhone"
    ...
    const-string v5, "getCallWaiting(): tbcwMode = "
    ...
    .line 1421
    invoke-static {p1, v0, v9}, Landroid/os/AsyncResult;->forMessage(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)Landroid/os/AsyncResult;
    ...
    .end local v2    # "tbcwMode":Ljava/lang/String;
    :cond_0
    :goto_0
    return-void

    .line 1425
    .restart local v2    # "tbcwMode":Ljava/lang/String;
    :cond_1
    const-string v3, "enabled_tbcw_off"
    ...
    .end local v0    # "cwInfos":[I
    :cond_2
    invoke-virtual {v1, p1}, Lcom/android/internal/telephony/imsphone/ImsPhone;->getCallWaiting(Landroid/os/Message;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-interface {v2, v3}, Lcom/android/internal/telephony/CommandsInterface;->getBasebandVersion(Landroid/os/Message;)V
    ...
    invoke-interface {v2, v3}, Lcom/android/internal/telephony/CommandsInterface;->getIMEI(Landroid/os/Message;)V
    ...
    invoke-interface {v2, v3}, Lcom/android/internal/telephony/CommandsInterface;->getIMEISV(Landroid/os/Message;)V
    ...
    invoke-interface {v2, v3}, Lcom/android/internal/telephony/CommandsInterface;->getPhoneRatFamily(Landroid/os/Message;)V
    ...
    iget-boolean v2, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->needQueryCfu:Z

    if-eqz v2, :cond_0

    .line 1790
    const-string v2, "persist.radio.cfu.querytype"
    ...
    .line 1791
    .local v11, "cfuSetting":Ljava/lang/String;
    const-string v21, "0"

    .line 1793
    .local v21, "isTestSim":Ljava/lang/String;
    const/16 v20, 0x0

    .line 1794
    .local v20, "isRRMEnv":Z
    const/16 v27, 0x0
    ...
    iget v2, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mPhoneId:I
    ...
    const-string v4, "[GSMPhone] CFU_KEY = "
    ...
    const-string v3, "persist.radio.cfu.change."
    ...
    const-string v4, "[GSMPhone] isChanged "
    ...
    iput v2, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mCfuQueryRetryCount:I
    ...
    iput-boolean v2, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->needQueryCfu:Z
    ...
    .line 1835
    .end local v11    # "cfuSetting":Ljava/lang/String;
    .end local v20    # "isRRMEnv":Z
    .end local v21    # "isTestSim":Ljava/lang/String;
    ...
    invoke-virtual {v0, v3, v2}, Lcom/android/internal/telephony/gsm/GSMPhone;->setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1867
    .local v22, "mSimConfig":Ljava/lang/String;
    ...
    .end local v22    # "mSimConfig":Ljava/lang/String;
    :sswitch_5
    move-object/from16 v0, p1
    ...
    invoke-virtual {v0, v2}, Lcom/android/internal/telephony/gsm/GSMPhone;->setDeviceIdAbnormal(I)V
    ...
    const-string v3, "Invalid format IMEI!!"
    ...
    invoke-direct {v0, v2, v3}, Lcom/android/internal/telephony/gsm/GSMPhone;->onIncomingUSSD(ILjava/lang/String;)V
    :try_end_1
    ...
    iget-object v15, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mImsPhone:Lcom/android/internal/telephony/imsphone/ImsPhone;
    ...
    iput-object v8, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mCachedSsn:Landroid/os/AsyncResult;
    ...
    :goto_3
    iget-object v4, v9, Lcom/android/internal/telephony/gsm/GSMPhone$Cfu;->mSetCfNumber:Ljava/lang/String;

    move-object/from16 v0, v28

    invoke-virtual {v0, v3, v2, v4}, Lcom/android/internal/telephony/uicc/IccRecords;->setVoiceCallForwardingFlag(IZLjava/lang/String;)V
    ...
    const-string v3, "[GSMPhone] handle EVENT_SET_VM_NUMBER_DONE"
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/gsm/GSMPhone;->getSubId()J
    ...
    const-string v3, "gsm.poweron.cfu.query."
    ...
    invoke-virtual {v0, v2, v3}, Lcom/android/internal/telephony/gsm/GSMPhone;->setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v4, "[EVENT_GET_CALL_FORWARD_DONE]ar.exception = "
    ...
    const-string v3, "SET_NETWORK_SELECTION_AUTOMATIC: set to automatic"
    ...
    const-string v3, "SET_NETWORK_SELECTION_AUTOMATIC: already automatic, ignore"
    ...
    const-string v3, "get phone RAT fail, no need to change mPhoneRatFamily"
    ...
    const-string v4, "EVENT_GET_PHONE_RAT_FAMILY : phone RAT family : "
    ...
    iget v4, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mPhoneRatFamily:I
    ...
    iput v2, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mPhoneRatFamily:I
    ...
    invoke-virtual {v2, v4, v3, v5}, Lcom/android/internal/telephony/uicc/IccRecords;->setVoiceCallForwardingFlag(IZLjava/lang/String;)V
    ...
    check-cast v25, Lcom/android/internal/telephony/gsm/SuppCrssNotification;

    .line 2055
    .local v25, "noti":Lcom/android/internal/telephony/gsm/SuppCrssNotification;
    move-object/from16 v0, v25

    iget v2, v0, Lcom/android/internal/telephony/gsm/SuppCrssNotification;->code:I
    ...
    .line 2065
    .local v12, "cn":Lcom/android/internal/telephony/gsm/GsmConnection;
    const-string v2, "GSMPhone"
    ...
    const-string v4, "set number presentation to connection : "
    ...
    iget v4, v0, Lcom/android/internal/telephony/gsm/SuppCrssNotification;->cli_validity:I
    ...
    iget v2, v0, Lcom/android/internal/telephony/gsm/SuppCrssNotification;->cli_validity:I
    ...
    invoke-virtual {v12, v2}, Lcom/android/internal/telephony/gsm/GsmConnection;->setNumberPresentation(I)V

    .line 2098
    .end local v12    # "cn":Lcom/android/internal/telephony/gsm/GsmConnection;
    :cond_14
    :goto_6
    move-object/from16 v0, p0

    iput-object v8, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mCachedCrssn:Landroid/os/AsyncResult;

    .line 2100
    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mCallRelatedSuppSvcRegistrants:Landroid/os/RegistrantList;
    ...
    .line 2068
    .restart local v12    # "cn":Lcom/android/internal/telephony/gsm/GsmConnection;
    :pswitch_2
    const/4 v2, 0x2
    ...
    const-string v4, "[COLP]noti.number = "
    ...
    invoke-virtual {v2}, Lcom/android/internal/telephony/gsm/GsmCall;->getConnections()Ljava/util/List;
    ...
    .line 2088
    .local v12, "cn":Lcom/android/internal/telephony/Connection;
    if-eqz v12, :cond_16
    ...
    iget-object v2, v0, Lcom/android/internal/telephony/gsm/SuppCrssNotification;->number:Ljava/lang/String;

    invoke-virtual {v12, v2}, Lcom/android/internal/telephony/Connection;->setRedirectingAddress(Ljava/lang/String;)V
    ...
    invoke-virtual {v12}, Lcom/android/internal/telephony/Connection;->getRedirectingAddress()Ljava/lang/String;
    ...
    .line 2105
    .end local v8    # "ar":Landroid/os/AsyncResult;
    .end local v12    # "cn":Lcom/android/internal/telephony/Connection;
    .end local v25    # "noti":Lcom/android/internal/telephony/gsm/SuppCrssNotification;
    :sswitch_13
    const-string v2, "GSMPhone"
    ...
    const-string v4, "[EVENT_CFU_QUERY_TIMEOUT]mCfuQueryRetryCount = "
    ...
    iget v4, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mCfuQueryRetryCount:I
    ...
    iget v2, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mCfuQueryRetryCount:I
    ...
    .line 2124
    :sswitch_16
    const-string v2, "handle EVENT_VOICE_CALL_INCOMING_INDICATION"
    ...
    iget-object v2, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mVoiceCallIncomingIndicationRegistrants:Landroid/os/RegistrantList;
    ...
    .line 2130
    :sswitch_17
    const-string v2, "handle EVENT_GET_AVAILABLE_NETWORK_DONE"
    ...
    invoke-interface {v2, v0}, Lcom/android/internal/telephony/CommandsInterface;->unregisterForGetAvailableNetworksDone(Landroid/os/Handler;)V
    ...
    invoke-virtual/range {v2 .. v7}, Lcom/android/internal/telephony/dataconnection/DctController;->setDataAllowed(JZJ)V

    goto/16 :goto_0

    .line 2135
    :sswitch_18
    const-string v2, "handle EVENT_ABNORMAL_EVENT"
    ...
    .line 2139
    .local v23, "msgString":[Ljava/lang/String;
    const/4 v14, 0x0
    ...
    .line 2144
    .end local v14    # "i":I
    .end local v23    # "msgString":[Ljava/lang/String;
    :cond_18
    new-instance v2, Ljava/lang/StringBuilder;
    ...
    .end local v8    # "ar":Landroid/os/AsyncResult;
    :sswitch_19
    const-string v2, "handle EVENT_SET_BAND_MODE_DONE"
    ...
    .line 2151
    const-string v2, "B40 broken. set band mode complete"
...
.method public setCallWaiting(ZLandroid/os/Message;)V
    ...
    const-string v4, "setCallWaiting(): tbcwMode = "
    ...
    .line 1458
    invoke-static {p2, v5, v5}, Landroid/os/AsyncResult;->forMessage(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)Landroid/os/AsyncResult;
...
.method public setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, v0, p2}, Landroid/telephony/TelephonyManager;->setTelephonyProperty(Ljava/lang/String;ILjava/lang/String;)V
