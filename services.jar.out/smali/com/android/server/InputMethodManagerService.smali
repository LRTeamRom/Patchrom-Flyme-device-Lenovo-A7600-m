...
.method private showInputMethodMenuInternal(Z)V
    ...
    .prologue
    .line 2903
    sget-boolean v29, Lcom/android/server/InputMethodManagerService;->DEBUG:Z

    if-eqz v29, :cond_0

    const-string v29, "InputMethodManagerService"

    const-string v30, "Show switching menu"
    ...
    invoke-virtual/range {v29 .. v29}, Lcom/android/internal/inputmethod/InputMethodUtils$InputMethodSettings;->getSelectedInputMethod()Ljava/lang/String;
    ...
    :cond_9
    invoke-virtual {v10}, Landroid/content/Context;->isCts()Z
    ...
    const v29, #android:style@Theme.DeviceDefault.Settings#t
    ...
    sget-object v31, Lcom/android/internal/R$styleable;->DialogPreference:[I

    const v32, #android:attr@alertDialogStyle#t
    ...
    new-instance v31, Lcom/android/server/InputMethodManagerService$5;
    ...
    const v29, #android:layout@input_method_switch_dialog_title#t
    ...
    .line 2980
    .local v28, "tv":Landroid/view/View;
    move-object/from16 v0, p0
    ...
    const v31, #android:id@hard_keyboard_section#t
    ...
    invoke-virtual/range {v29 .. v29}, Lcom/android/server/wm/WindowManagerService;->isHardKeyboardAvailable()Z
    ...
    const v31, #android:id@alertTitle#t
    ...
    const v31, #android:id@hard_keyboard_switch#t
    ...
    const v29, #android:layout@input_method_switch_item#t
    ...
    const v31, #android:string@configure_input_methods#t
    ...
    invoke-virtual/range {v29 .. v29}, Landroid/app/AlertDialog;->getWindow()Landroid/view/Window;
    ...
    const-string v31, "Select input method"
    ...
    .end local v28    # "tv":Landroid/view/View;
    :catchall_0
    move-exception v29
    ...
    .restart local v18    # "isCts":Z
    .restart local v23    # "mNeedfindInputMethod":Z
    :cond_c
    const v29, #android:style@Theme.DeviceDefault.Light#t
    ...
    .restart local v28    # "tv":Landroid/view/View;
    :cond_d
    const/16 v29, 0x8
...
.method public systemRunning(Lcom/android/server/statusbar/StatusBarManagerService;)V
    ...
    const v9, #android:bool@show_ongoing_ime_switcher#t
