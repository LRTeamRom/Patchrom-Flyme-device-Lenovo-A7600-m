...
.method public static isDeviceEncrypted()Z
    ...
    const-string v7, "isDeviceEncrypted() - getEncryptionState = "
    ...
    const-string v5, "IllegalStateException happend "
...
.method public saveLockPattern(Ljava/util/List;ZLjava/lang/String;)V
    ...
    invoke-interface {v3, v4, v11}, Lcom/android/internal/widget/ILockSettings;->setLockPattern(Ljava/lang/String;I)V
    ...
    invoke-virtual {v0, v3}, Lcom/android/internal/widget/LockPatternUtils;->isCredentialRequiredToDecrypt(Z)Z

    move-result v23

    .line 636
    .local v23, "required":Z
    const-string v3, "LockPatternUtils"
    ...
    .line 641
    .local v24, "stringPattern":Ljava/lang/String;
    const-string v3, "LockPatternUtils"
    ...
    .end local v11    # "userId":I
    .end local v23    # "required":Z
    .end local v24    # "stringPattern":Ljava/lang/String;
    :catch_0
    move-exception v22
