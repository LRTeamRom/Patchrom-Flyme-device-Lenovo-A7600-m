...
# virtual methods
.method public addToWhiteList(Landroid/app/NameInfo;)Z
    .locals 11
    ...
    .line 1602
    iget-object v2, p1, Landroid/app/NameInfo;->name:Ljava/lang/String;
    ...
    iget-object v4, p1, Landroid/app/NameInfo;->workNumber:Ljava/lang/String;

    .line 1605
    .local v4, "workNumber":Ljava/lang/String;
    iget-object v1, p1, Landroid/app/NameInfo;->homeNumber:Ljava/lang/String;

    .line 1607
    .local v1, "homeNumber":Ljava/lang/String;
    :try_start_0
    ...
    const-string v8, "addToWhiteList "
    ...
    # invokes: Lcom/android/server/notification/NotificationManagerService;->setDbHelper()V
    invoke-static {v6}, Lcom/android/server/notification/NotificationManagerService;->access$3300(Lcom/android/server/notification/NotificationManagerService;)V

    .line 1610
    iget-object v6, p0, Lcom/android/server/notification/NotificationManagerService$5;->this$0:Lcom/android/server/notification/NotificationManagerService;

    # invokes: Lcom/android/server/notification/NotificationManagerService;->ExistInDatabase(Landroid/app/NameInfo;)Z
    invoke-static {v6, p1}, Lcom/android/server/notification/NotificationManagerService;->access$3400(Lcom/android/server/notification/NotificationManagerService;Landroid/app/NameInfo;)Z
    ...
    const-string v7, "phone has existed"
    ...
    # getter for: Lcom/android/server/notification/NotificationManagerService;->dbHelper:Lcom/android/server/notification/WhiteListDbHelper;
    invoke-static {v6}, Lcom/android/server/notification/NotificationManagerService;->access$3500(Lcom/android/server/notification/NotificationManagerService;)Lcom/android/server/notification/WhiteListDbHelper;

    move-result-object v6

    iget-object v7, p1, Landroid/app/NameInfo;->name:Ljava/lang/String;

    iget-object v8, p1, Landroid/app/NameInfo;->number:Ljava/lang/String;

    iget-object v9, p1, Landroid/app/NameInfo;->workNumber:Ljava/lang/String;

    iget-object v10, p1, Landroid/app/NameInfo;->homeNumber:Ljava/lang/String;

    invoke-virtual {v6, v7, v8, v9, v10}, Lcom/android/server/notification/WhiteListDbHelper;->insert(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
...
.method public cancelNotificationFromListener(Landroid/service/notification/INotificationListener;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-static {v0}, Lcom/android/server/notification/NotificationManagerService;->access$500(Lcom/android/server/notification/NotificationManagerService;)Lcom/android/server/notification/NotificationManagerService$NotificationListeners;
...
.method public getActiveNotificationsFromListener(Landroid/service/notification/INotificationListener;[Ljava/lang/String;I)Landroid/content/pm/ParceledListSlice;
    ...
    # getter for: Lcom/android/server/notification/NotificationManagerService;->mListeners:Lcom/android/server/notification/NotificationManagerService$NotificationListeners;
    invoke-static {v8}, Lcom/android/server/notification/NotificationManagerService;->access$500(Lcom/android/server/notification/NotificationManagerService;)Lcom/android/server/notification/NotificationManagerService$NotificationListeners;
...
.method public getAutomaticZenModeConditions()[Landroid/service/notification/Condition;
    ...
    invoke-static {v0}, Lcom/android/server/notification/NotificationManagerService;->access$600(Lcom/android/server/notification/NotificationManagerService;)Lcom/android/server/notification/ConditionProviders;
...
.method public getEffectsSuppressor()Landroid/content/ComponentName;
    ...
    invoke-static {v0}, Lcom/android/server/notification/NotificationManagerService;->access$3200(Lcom/android/server/notification/NotificationManagerService;)Landroid/content/ComponentName;
...
.method public getWhiteList()[Landroid/app/NameInfo;
    .locals 7
    ...
    # getter for: Lcom/android/server/notification/NotificationManagerService;->dbHelper:Lcom/android/server/notification/WhiteListDbHelper;
    invoke-static {v4}, Lcom/android/server/notification/NotificationManagerService;->access$3500(Lcom/android/server/notification/NotificationManagerService;)Lcom/android/server/notification/WhiteListDbHelper;
    ...
    .line 1644
    .local v3, "list":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/app/NameInfo;>;"
    ...
    new-array v0, v4, [Landroid/app/NameInfo;

    .line 1649
    .local v0, "buff":[Landroid/app/NameInfo;
    const/4 v2, 0x0
...
.method public notifyConditions(Ljava/lang/String;Landroid/service/notification/IConditionProvider;[Landroid/service/notification/Condition;)V
    ...
    # getter for: Lcom/android/server/notification/NotificationManagerService;->mConditionProviders:Lcom/android/server/notification/ConditionProviders;
    invoke-static {v3}, Lcom/android/server/notification/NotificationManagerService;->access$600(Lcom/android/server/notification/NotificationManagerService;)Lcom/android/server/notification/ConditionProviders;
...
.method public removeAllNotifications(Ljava/lang/String;I)V
    ...
    invoke-static {v3, v2, v5, v6}, Lcom/android/server/notification/NotificationManagerService;->access$3100(Lcom/android/server/notification/NotificationManagerService;Lcom/android/server/notification/NotificationRecord;ZI)V
...
.method public removeFromWhiteList(Landroid/app/NameInfo;)Z
    .locals 7
    .param p1, "info"    # Landroid/app/NameInfo;
    ...
    .line 1624
    iget-object v1, p1, Landroid/app/NameInfo;->name:Ljava/lang/String;

    .line 1625
    .local v1, "name":Ljava/lang/String;
    iget-object v2, p1, Landroid/app/NameInfo;->number:Ljava/lang/String;
    ...
    const-string v6, "removeFromWhiteList "
    ...
    iget-object v6, p1, Landroid/app/NameInfo;->workNumber:Ljava/lang/String;
    ...
    iget-object v6, p1, Landroid/app/NameInfo;->homeNumber:Ljava/lang/String;
    ...
    # invokes: Lcom/android/server/notification/NotificationManagerService;->ExistInDatabase(Landroid/app/NameInfo;)Z
    invoke-static {v4, p1}, Lcom/android/server/notification/NotificationManagerService;->access$3400(Lcom/android/server/notification/NotificationManagerService;Landroid/app/NameInfo;)Z
    ...
    invoke-virtual {v4, p1}, Lcom/android/server/notification/WhiteListDbHelper;->delete(Landroid/app/NameInfo;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public requestHintsFromListener(Landroid/service/notification/INotificationListener;I)V
    ...
    # getter for: Lcom/android/server/notification/NotificationManagerService;->mListeners:Lcom/android/server/notification/NotificationManagerService$NotificationListeners;
    invoke-static {v4}, Lcom/android/server/notification/NotificationManagerService;->access$500(Lcom/android/server/notification/NotificationManagerService;)Lcom/android/server/notification/NotificationManagerService$NotificationListeners;
...
.method public requestInterruptionFilterFromListener(Landroid/service/notification/INotificationListener;I)V
    ...
    invoke-static {v2}, Lcom/android/server/notification/NotificationManagerService;->access$1600(Lcom/android/server/notification/NotificationManagerService;)V
