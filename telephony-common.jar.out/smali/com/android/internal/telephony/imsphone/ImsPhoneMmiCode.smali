...
.method processCode()V
    ...
    const-string v18, "Sending short code \'"
    ...
    invoke-virtual {v0, v8, v1}, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v8

    invoke-virtual {v3, v5, v8}, Lcom/android/internal/telephony/imsphone/ImsPhone;->getCallForwardingOption(ILandroid/os/Message;)V
    ...
    .line 763
    .local v13, "isEnableDesired":I
    :goto_3
    const-string v3, "ImsPhoneMmiCode"

    const-string v8, "is CF setCallForward"
    ...
    invoke-virtual {v0, v8, v14, v13, v1}, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    .end local v13    # "isEnableDesired":I
    ...
    .line 759
    .restart local v14    # "isSettingUnconditional":I
    :cond_b
    const/4 v13, 0x0
    ...
    invoke-virtual {v3, v12, v8}, Lcom/android/internal/telephony/imsphone/ImsPhone;->getCallBarring(Ljava/lang/String;Landroid/os/Message;)V
    ...
    invoke-virtual {v3, v12, v8, v0, v1}, Lcom/android/internal/telephony/imsphone/ImsPhone;->setCallBarring(Ljava/lang/String;ZLjava/lang/String;Landroid/os/Message;)V
    ...
    invoke-interface {v3, v8, v0}, Lcom/android/ims/ImsUtInterface;->updateCLIR(ILandroid/os/Message;)V
    :try_end_2
    ...
    const-string v8, "Could not get UT handle for updateCLIR."
    ...
    .line 803
    .restart local v10    # "e":Lcom/android/ims/ImsException;
    :try_start_5
    const-string v3, "ImsPhoneMmiCode"
    ...
    invoke-interface {v3, v8}, Lcom/android/ims/ImsUtInterface;->queryCLIR(Landroid/os/Message;)V
    :try_end_6
    ...
    const-string v8, "Could not get UT handle for queryCLIR."
    ...
    invoke-interface {v3, v8}, Lcom/android/ims/ImsUtInterface;->queryCLIP(Landroid/os/Message;)V
    :try_end_8
    ...
    const-string v8, "Could not get UT handle for queryCLIP."
    ...
    invoke-interface {v3, v8, v0}, Lcom/android/ims/ImsUtInterface;->updateCLIP(ZLandroid/os/Message;)V
    :try_end_a
    ...
    const-string v8, "Could not get UT handle for updateCLIP."
    ...
    invoke-interface {v3, v8}, Lcom/android/ims/ImsUtInterface;->queryCOLP(Landroid/os/Message;)V
    :try_end_c
    ...
    const-string v8, "Could not get UT handle for queryCOLP."
    ...
    invoke-interface {v3, v8, v0}, Lcom/android/ims/ImsUtInterface;->updateCOLP(ZLandroid/os/Message;)V
    :try_end_e
    ...
    const-string v8, "Could not get UT handle for updateCOLP."
    ...
    invoke-interface {v3, v8, v0}, Lcom/android/ims/ImsUtInterface;->updateCOLR(ILandroid/os/Message;)V
    :try_end_10
    ...
    const-string v8, "Could not get UT handle for updateCOLR."
    ...
    invoke-interface {v3, v8}, Lcom/android/ims/ImsUtInterface;->queryCOLR(Landroid/os/Message;)V
    :try_end_14
    ...
    const-string v8, "Could not get UT handle for queryCOLR."
    ...
    invoke-interface {v3, v8, v0}, Lcom/android/ims/ImsUtInterface;->queryCallBarring(ILandroid/os/Message;)V
    :try_end_16
    ...
    const-string v8, "Could not get UT handle for ICB."
    ...
    const-string v8, "Could not get UT handle for ICBa."
    ...
    const-string v18, "disabled_tbcw"

    move-object/from16 v0, v18

    invoke-virtual {v3, v8, v0}, Lcom/android/internal/telephony/PhoneBase;->getSystemProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v17

    .line 911
    .local v17, "tbcwMode":Ljava/lang/String;
    const-string v3, "ImsPhoneMmiCode"
    ...
    const-string v18, "setCallWaiting(): tbcwMode = "
    ...
    const-string v18, "enabled_tbcw_off"

    move-object/from16 v0, v18

    invoke-virtual {v3, v8, v0}, Lcom/android/internal/telephony/PhoneBase;->setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v3, v8}, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-static {v15, v3, v8}, Landroid/os/AsyncResult;->forMessage(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)Landroid/os/AsyncResult;

    .line 921
    move-object/from16 v0, p0

    invoke-virtual {v0, v15}, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->sendMessage(Landroid/os/Message;)Z
    ...
    const-string v18, "enabled_tbcw_on"
    ...
    invoke-virtual {v3, v8, v0}, Lcom/android/internal/telephony/imsphone/ImsPhone;->setCallWaiting(ZLandroid/os/Message;)V

    goto/16 :goto_0

    .line 935
    .end local v17    # "tbcwMode":Ljava/lang/String;
    :cond_2a
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->isInterrogate()Z
    ...
    .line 940
    .restart local v17    # "tbcwMode":Ljava/lang/String;
    const-string v3, "ImsPhoneMmiCode"
    ...
    const-string v18, "SC_WAIT isInterrogate() tbcwMode = "
    ...
    invoke-static {v15, v9, v3}, Landroid/os/AsyncResult;->forMessage(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)Landroid/os/AsyncResult;
    ...
    invoke-virtual {v3, v8}, Lcom/android/internal/telephony/imsphone/ImsPhone;->getCallWaiting(Landroid/os/Message;)V
    ...
    const-string v18, "Sending pound string \'"
