...
.method private ensureActiveMobilePolicyLocked()V
    ...
    .line 1304
    .local v24, "subId":J
    invoke-static/range {v24 .. v25}, Landroid/telephony/SubscriptionManager;->getSlotId(J)I
    ...
    invoke-static/range {v24 .. v25}, Landroid/telephony/SubscriptionManager;->isValidSubId(J)Z
    ...
    .line 1310
    invoke-virtual/range {v23 .. v25}, Landroid/telephony/TelephonyManager;->getSubscriberId(J)Ljava/lang/String;
...
.method private sendPolicyCreatedBroadcast()V
    ...
    const-string v2, "sendPolicyCreatedBroadcast ACTION_POLICYMGR_CREATED"
...
.method private setNetworkTemplateEnabled(JLandroid/net/NetworkTemplate;Z)V
    .locals 5
    .param p1, "subId"    # J
    .param p3, "template"    # Landroid/net/NetworkTemplate;
    .param p4, "enabled"    # Z
    ...
    .line 1092
    invoke-virtual {v1, p1, p2, p4}, Landroid/telephony/TelephonyManager;->setPolicyDataEnableForSubscriber(JZ)V

    .line 1093
    const/4 v2, 0x6

    invoke-direct {p0, v2, p4}, Lcom/android/server/net/NetworkPolicyManagerService;->setPolicyDataEnable(IZ)V
    ...
    const-string v3, " Error!! setNetworkTemplateEnabled( MATCH_WIFI_WILDCARD )"
...
.method addNetworkPolicyLocked(Landroid/net/NetworkPolicy;)V
    ...
    const-string v1, " Error!! addNetworkPolicyLocked( MATCH_WIFI_WILDCARD )"
...
.method updateNetworkEnabledLocked()V
    ...
    invoke-direct {v0, v10, v11, v2, v3}, Lcom/android/server/net/NetworkPolicyManagerService;->setNetworkTemplateEnabled(JLandroid/net/NetworkTemplate;Z)V
    ...
    invoke-direct {v0, v10, v11, v2, v13}, Lcom/android/server/net/NetworkPolicyManagerService;->setNetworkTemplateEnabled(JLandroid/net/NetworkTemplate;Z)V
