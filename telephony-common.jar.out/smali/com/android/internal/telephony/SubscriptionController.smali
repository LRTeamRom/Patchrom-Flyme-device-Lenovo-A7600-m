...
.field private static sSimInfo:Ljava/util/concurrent/ConcurrentHashMap;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/internal/telephony/SubscriptionController;->sSimInfo:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private constructor <init>(Lcom/android/internal/telephony/Phone;)V
    ...
    iput-boolean v0, p0, Lcom/android/internal/telephony/SubscriptionController;->mIsOP01:Z
...
.method private getSubInfoRecord(Landroid/database/Cursor;)Landroid/telephony/SubInfoRecord;
    ...
    .line 284
    iget-boolean v2, p0, Lcom/android/internal/telephony/SubscriptionController;->mIsOP01:Z
...
.method private isSubInfoReady()Z
    ...
    .prologue
    .line 216
    sget-object v0, Lcom/android/internal/telephony/SubscriptionController;->sSimInfo:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public addSubInfoRecord(Ljava/lang/String;I)I
    ...
    .line 553
    :cond_1
    const-string v6, "[addSubInfoRecord]- getSubId fail"
    ...
    .line 560
    .local v5, "mSpnOverride":Lcom/android/internal/telephony/uicc/SpnOverride;
    ...
    aget-wide v10, v28, v7

    invoke-virtual {v6, v10, v11}, Landroid/telephony/TelephonyManager;->getSimOperator(J)Ljava/lang/String;
    ...
    const-string v7, "[addSubInfoRecord] CarrierName = "
    ...
    .line 563
    invoke-virtual {v5, v8}, Lcom/android/internal/telephony/uicc/SpnOverride;->containsCarrier(Ljava/lang/String;)Z
    ...
    iget-boolean v6, v0, Lcom/android/internal/telephony/SubscriptionController;->mIsOP01:Z
    ...
    invoke-virtual/range {v5 .. v10}, Lcom/android/internal/telephony/uicc/SpnOverride;->lookupOperatorName(JLjava/lang/String;ZLandroid/content/Context;)Ljava/lang/String;

    move-result-object v20

    .line 576
    .local v20, "nameToSet":Ljava/lang/String;
    :goto_1
    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "[addSubInfoRecord] SPN Found, name = "
    ...
    invoke-virtual {v9, v6, v0}, Landroid/content/ContentResolver;->insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    .line 602
    new-instance v21, Landroid/telephony/SubInfoRecord;

    invoke-direct/range {v21 .. v21}, Landroid/telephony/SubInfoRecord;-><init>()V

    .line 603
    .local v21, "newRecord":Landroid/telephony/SubInfoRecord;
    ...
    iput-wide v6, v0, Landroid/telephony/SubInfoRecord;->subId:J
    ...
    iput-object v0, v1, Landroid/telephony/SubInfoRecord;->iccId:Ljava/lang/String;
    ...
    iput v0, v1, Landroid/telephony/SubInfoRecord;->slotId:I
    ...
    iput v0, v1, Landroid/telephony/SubInfoRecord;->color:I
    ...
    iput-object v0, v1, Landroid/telephony/SubInfoRecord;->displayName:Ljava/lang/String;

    .line 608
    move-object/from16 v0, v21

    iget-object v6, v0, Landroid/telephony/SubInfoRecord;->simIconRes:[I

    const/4 v7, 0x0

    sget-object v10, Lcom/android/internal/telephony/SubscriptionController;->sSimBackgroundDarkRes:[I

    move-object/from16 v0, v21

    iget v11, v0, Landroid/telephony/SubInfoRecord;->color:I
    ...
    sget-object v10, Lcom/android/internal/telephony/SubscriptionController;->sSimBackgroundLightRes:[I
    ...
    .line 672
    sget-object v6, Lcom/android/internal/telephony/SubscriptionController;->sSimInfo:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 673
    .local v4, "currentSubId":Ljava/lang/Long;
    if-eqz v4, :cond_7
    ...
    .line 682
    .local v24, "simCount":I
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/SubscriptionController;->getDefaultSubId()J

    move-result-wide v16

    .line 683
    .local v16, "defaultSubId":J
    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "[addSubInfoRecord] sSimInfo.size="

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    sget-object v7, Lcom/android/internal/telephony/SubscriptionController;->sSimInfo:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static/range {v26 .. v27}, Landroid/telephony/SubscriptionManager;->isValidSubId(J)Z
    ...
    .line 702
    .end local v16    # "defaultSubId":J
    .end local v24    # "simCount":I
    :cond_a
    :goto_4
    new-instance v6, Ljava/lang/StringBuilder;
    ...
    .line 706
    .end local v4    # "currentSubId":Ljava/lang/Long;
    :cond_b
    if-eqz v15, :cond_c
    ...
    .end local v20    # "nameToSet":Ljava/lang/String;
    .end local v21    # "newRecord":Landroid/telephony/SubInfoRecord;
    ...
    .restart local v20    # "nameToSet":Ljava/lang/String;
    goto/16 :goto_1
    ...
    const-string v7, "[addSubInfoRecord] SPN Not found, name = "
    ...
    .restart local v26    # "subId":J
    .restart local v29    # "uri":Landroid/net/Uri;
    :cond_10
    :try_start_2
    move-object/from16 v0, p0

    invoke-direct {v0, v15}, Lcom/android/internal/telephony/SubscriptionController;->getSubInfoRecord(Landroid/database/Cursor;)Landroid/telephony/SubInfoRecord;

    move-result-object v21

    .line 614
    .restart local v21    # "newRecord":Landroid/telephony/SubInfoRecord;
    const-string v6, "_id"
    ...
    iget v6, v0, Landroid/telephony/SubInfoRecord;->slotId:I

    move-object/from16 v0, v21

    iput v6, v0, Landroid/telephony/SubInfoRecord;->color:I
    ...
    invoke-virtual {v9, v6, v0, v7, v10}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I

    move-result v23

    .line 646
    :cond_13
    const-string v6, "[addSubInfoRecord]- Record already exist"
    ...
    .line 700
    .restart local v4    # "currentSubId":Ljava/lang/Long;
    .restart local v21    # "newRecord":Landroid/telephony/SubInfoRecord;
    .restart local v30    # "value":Landroid/content/ContentValues;
    :cond_15
    :try_start_3
...
.method public clearSubInfo()I
    ...
    .line 1095
    sget-object v1, Lcom/android/internal/telephony/SubscriptionController;->sSimInfo:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public clearSubInfo(I)I
    .locals 5
    .param p1, "slotId"    # I
    ...
    const-string v4, "[clearSubInfo]+, slotId = "
    ...
    .line 1579
    sget-object v3, Lcom/android/internal/telephony/SubscriptionController;->sSimInfo:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    const-string v4, "[clearSubInfo]- before mapping size="
    ...
    const-string v4, "[clearSubInfo]- before active size="
    ...
    .local v1, "records":Ljava/util/Iterator;, "Ljava/util/Iterator<Landroid/telephony/SubInfoRecord;>;"
    :cond_1
    :goto_1
    ...
    .line 1597
    .local v0, "record":Landroid/telephony/SubInfoRecord;
    iget v3, v0, Landroid/telephony/SubInfoRecord;->slotId:I
    ...
    .line 1601
    .end local v0    # "record":Landroid/telephony/SubInfoRecord;
    :cond_2
    iget-object v3, p0, Lcom/android/internal/telephony/SubscriptionController;->mActiveList:Ljava/util/List;
    ...
    const-string v4, "[clearSubInfo]- after clear size="
    ...
    .end local v1    # "records":Ljava/util/Iterator;, "Ljava/util/Iterator<Landroid/telephony/SubInfoRecord;>;"
    :cond_3
    move v3, v2
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 1472
    sget-object v4, Lcom/android/internal/telephony/SubscriptionController;->sSimInfo:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public getActiveSubInfoList()Ljava/util/List;
    ...
    const-string v1, "[getActiveSubInfoList]- "
    ...
    .line 487
    :cond_1
    const-string v0, "[getActiveSubInfoList]- no info return"
...
.method public getDefaultSubId()J
    ...
    const-string v3, "multi_sim_common"
...
.method public getPhoneId(J)I
    ...
    const-string v8, "[getPhoneId]- invalid subId, subId = "
    ...
    :cond_2
    sget-object v5, Lcom/android/internal/telephony/SubscriptionController;->sSimInfo:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    const-string v8, "[getPhoneId]- no sims, returning defaultPhoneId, subId = "
    ...
    const-string v8, "[getPhoneId]- return phoneId ="
    ...
    const-string v8, "[getPhoneId]- return mDefaultPhoneId, subId = "
...
.method public getSlotId(J)I
    ...
    .line 950
    const-string v6, "[getSlotId]+ subId == SubscriptionManager.DEFAULT_SUB_ID"
    ...
    const-string v8, "[getSlotId]- return INVALID_SLOT_ID, subId = "
...
.method public getSubId(I)[J
    ...
    .line 991
    const-string v11, "[getSubId]+ slotId == SubscriptionManager.DEFAULT_SLOT_ID"
    ...
    const-string v12, "[getSubId]- invalid slotId, slotId = "
    ...
    const-string v12, "[getSubId]- slotId < 0, return dummy instead, slotId = "
    ...
    .line 1009
    :cond_2
    sget-object v11, Lcom/android/internal/telephony/SubscriptionController;->sSimInfo:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    const-string v12, "[getSubId]- size == 0, return dummy instead, slotId = "
    ...
    const-string v12, "[getSubId]- numSubIds == 0, return dummy instead, slotId = "
...
.method public getSubInfoForSubscriber(J)Landroid/telephony/SubInfoRecord;
    ...
    .line 367
    .local v7, "result":Landroid/telephony/SubInfoRecord;
    const-wide v0, 0x7fffffffffffffffL
    ...
    .line 383
    const-string v0, "[getSubInfoForSubscriberx] !isSubInfoReady(), change slot Id"
    ...
    iput v0, v7, Landroid/telephony/SubInfoRecord;->slotId:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setColor(IJ)I
    ...
    check-cast v7, Landroid/telephony/SubInfoRecord;

    .line 747
    .local v7, "record":Landroid/telephony/SubInfoRecord;
    iget-wide v2, v7, Landroid/telephony/SubInfoRecord;->subId:J
    ...
    .line 748
    iput p1, v7, Landroid/telephony/SubInfoRecord;->color:I

    .line 749
    iget-object v1, v7, Landroid/telephony/SubInfoRecord;->simIconRes:[I

    const/4 v2, 0x0

    sget-object v3, Lcom/android/internal/telephony/SubscriptionController;->sSimBackgroundDarkRes:[I

    iget v4, v7, Landroid/telephony/SubInfoRecord;->color:I
    ...
    sget-object v2, Lcom/android/internal/telephony/SubscriptionController;->sSimBackgroundLightRes:[I

    iget v3, v7, Landroid/telephony/SubInfoRecord;->color:I
    ...
    .end local v7    # "record":Landroid/telephony/SubInfoRecord;
    :cond_3
...
.method public setDataRoaming(IJ)I
    ...
    .line 897
    iput p1, v7, Landroid/telephony/SubInfoRecord;->dataRoaming:I
...
.method public setDefaultSubId(J)V
    ...
    const-string v4, "multi_sim_common"
    ...
    invoke-virtual {v3, p1, p2}, Landroid/telephony/TelephonyManager;->getSimOperator(J)Ljava/lang/String;
...
.method public setDisplayNameUsingSrc(Ljava/lang/String;JJ)I
    ...
    .line 809
    iput-object v6, v7, Landroid/telephony/SubInfoRecord;->displayName:Ljava/lang/String;
    ...
    iput v1, v7, Landroid/telephony/SubInfoRecord;->nameSource:I
...
.method public setDisplayNumber(Ljava/lang/String;J)I
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Lcom/android/internal/telephony/SubscriptionController;->setDisplayNumber(Ljava/lang/String;JZ)I
...
.method public setDisplayNumber(Ljava/lang/String;JZ)I
    .locals 20
    .param p1, "number"    # Ljava/lang/String;
    .param p2, "subId"    # J
    .param p4, "writeToSim"    # Z
    ...
    invoke-interface {v13, v4, v0, v1}, Lcom/android/internal/telephony/Phone;->setLine1Number(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    check-cast v15, Landroid/telephony/SubInfoRecord;

    .line 1558
    .local v15, "record":Landroid/telephony/SubInfoRecord;
    iget-wide v6, v15, Landroid/telephony/SubInfoRecord;->subId:J
    ...
    iput-object v0, v15, Landroid/telephony/SubInfoRecord;->number:Ljava/lang/String;

    goto :goto_2

    .line 1545
    .end local v12    # "i$":Ljava/util/Iterator;
    .end local v15    # "record":Landroid/telephony/SubInfoRecord;
...
.method public setDisplayNumberFormat(IJ)I
    ...
    .line 860
    iput p1, v7, Landroid/telephony/SubInfoRecord;->displayNumberFormat:I
...
.method public setMccMnc(Ljava/lang/String;J)I
    ...
    invoke-virtual {v1, v2, v11, v3, v6}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    check-cast v9, Landroid/telephony/SubInfoRecord;

    .line 933
    .local v9, "record":Landroid/telephony/SubInfoRecord;
    iget-wide v2, v9, Landroid/telephony/SubInfoRecord;->subId:J
    ...
    .line 934
    iput v5, v9, Landroid/telephony/SubInfoRecord;->mcc:I

    .line 935
    iput v8, v9, Landroid/telephony/SubInfoRecord;->mnc:I

    goto :goto_1

    .line 920
    .end local v7    # "i$":Ljava/util/Iterator;
    .end local v9    # "record":Landroid/telephony/SubInfoRecord;
