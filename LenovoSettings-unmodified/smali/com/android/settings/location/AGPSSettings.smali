.class public Lcom/android/settings/location/AGPSSettings;
...
.method public constructor <init>()V
    ...
    .line 109
    new-instance v0, Lcom/android/settings/location/AGPSSettings$1;

    invoke-direct {v0, p0}, Lcom/android/settings/location/AGPSSettings$1;-><init>(Lcom/android/settings/location/AGPSSettings;)V

    iput-object v0, p0, Lcom/android/settings/location/AGPSSettings;->mSettingsObserver:Ljava/util/Observer;
...
.method private SetValue(Landroid/os/Bundle;)V
    ...
    .line 578
    iget-object v5, p0, Lcom/android/settings/location/AGPSSettings;->mContentResolver:Landroid/content/ContentResolver;
...
.method static synthetic access$000(Lcom/android/settings/location/AGPSSettings;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings/location/AGPSSettings;

    .prologue
    .line 40
    invoke-direct {p0}, Lcom/android/settings/location/AGPSSettings;->updateUI()V
...
.method private checkNotSet(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v0, Lcom/android/settings/location/AGPSSettings;->sNotSet:Ljava/lang/String;
...
.method private checkNull(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 357
    sget-object p1, Lcom/android/settings/location/AGPSSettings;->sNotSet:Ljava/lang/String;
...
.method private fillUi(Z)V
    ...
    .prologue
    .line 325
    iget-boolean v0, p0, Lcom/android/settings/location/AGPSSettings;->mFirstTime:Z
    ...
    iput-boolean v0, p0, Lcom/android/settings/location/AGPSSettings;->mFirstTime:Z

    .line 328
    iget-object v0, p0, Lcom/android/settings/location/AGPSSettings;->mServer:Landroid/preference/EditTextPreference;

    invoke-direct {p0}, Lcom/android/settings/location/AGPSSettings;->getSuplServer()Ljava/lang/String;
    ...
    .line 329
    iget-object v0, p0, Lcom/android/settings/location/AGPSSettings;->mPort:Landroid/preference/EditTextPreference;

    invoke-direct {p0}, Lcom/android/settings/location/AGPSSettings;->getSuplPort()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/settings/location/AGPSSettings;->mServer:Landroid/preference/EditTextPreference;

    invoke-virtual {v1}, Landroid/preference/EditTextPreference;->getText()Ljava/lang/String;

    move-result-object v1

    invoke-direct {p0, v1}, Lcom/android/settings/location/AGPSSettings;->checkNull(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/settings/location/AGPSSettings;->mPort:Landroid/preference/EditTextPreference;
    ...
    .line 334
    invoke-direct {p0}, Lcom/android/settings/location/AGPSSettings;->setPrefAgpsType()V

    .line 335
    invoke-direct {p0}, Lcom/android/settings/location/AGPSSettings;->setPrefAgpsNetwork()V

    .line 336
    invoke-direct {p0}, Lcom/android/settings/location/AGPSSettings;->setPrefAgpsResetType()V
...
.method private getPrefAgpsResetType()Ljava/lang/String;
    ...
    .prologue
    .line 400
    iget-object v1, p0, Lcom/android/settings/location/AGPSSettings;->mContentResolver:Landroid/content/ContentResolver;
    ...
    .line 418
    :cond_3
    invoke-virtual {p0}, Lcom/android/settings/location/AGPSSettings;->getResources()Landroid/content/res/Resources;
...
.method private restoreAgpsParam()V
    ...
    iput-object v8, p0, Lcom/android/settings/location/AGPSSettings;->mAssistedType:Ljava/lang/String;

    .line 531
    const-string v8, "HOME"

    iput-object v8, p0, Lcom/android/settings/location/AGPSSettings;->mNetworkType:Ljava/lang/String;

    .line 532
    const-string v8, "HOT"

    iput-object v8, p0, Lcom/android/settings/location/AGPSSettings;->mResetType:Ljava/lang/String;

    .line 534
    const-string v8, "providerid"

    iget-object v9, p0, Lcom/android/settings/location/AGPSSettings;->mAssistedType:Ljava/lang/String;
    ...
    iget-object v9, p0, Lcom/android/settings/location/AGPSSettings;->mNetworkType:Ljava/lang/String;
    ...
    iget-object v9, p0, Lcom/android/settings/location/AGPSSettings;->mResetType:Ljava/lang/String;

    invoke-virtual {v1, v8, v9}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    .line 538
    invoke-direct {p0, v1}, Lcom/android/settings/location/AGPSSettings;->SetValue(Landroid/os/Bundle;)V

    .line 540
    const/4 v8, 0x1

    invoke-direct {p0, v8}, Lcom/android/settings/location/AGPSSettings;->fillUi(Z)V

    .line 542
    const-string v8, "location"

    invoke-virtual {p0, v8}, Lcom/android/settings/location/AGPSSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v8, p0, Lcom/android/settings/location/AGPSSettings;->mResetType:Ljava/lang/String;
    ...
    .line 558
    :goto_1
    invoke-direct {p0}, Lcom/android/settings/location/AGPSSettings;->getAndroidSdkVersion()I
...
.method private saveAgpsParams()V
    ...
    iget-object v4, p0, Lcom/android/settings/location/AGPSSettings;->mServer:Landroid/preference/EditTextPreference;

    invoke-virtual {v4}, Landroid/preference/EditTextPreference;->getText()Ljava/lang/String;

    move-result-object v4

    invoke-direct {p0, v4}, Lcom/android/settings/location/AGPSSettings;->checkNotSet(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/android/settings/location/AGPSSettings;->mPort:Landroid/preference/EditTextPreference;
    ...
    iget-object v4, p0, Lcom/android/settings/location/AGPSSettings;->mAssistedType:Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/android/settings/location/AGPSSettings;->mNetworkType:Ljava/lang/String;
    ...
    .line 470
    iget-object v3, p0, Lcom/android/settings/location/AGPSSettings;->mResetType:Ljava/lang/String;
    ...
    invoke-virtual {p0, v3}, Lcom/android/settings/location/AGPSSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
...
.method private setPrefAgpsNetwork()V
    ...
    invoke-virtual {p0, v3}, Lcom/android/settings/location/AGPSSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-direct {p0}, Lcom/android/settings/location/AGPSSettings;->getPrefNetwork()Ljava/lang/String;

    move-result-object v0

    .line 236
    .local v0, "defPref":Ljava/lang/String;
    iput-object v0, p0, Lcom/android/settings/location/AGPSSettings;->mNetworkType:Ljava/lang/String;
...
.method private setPrefAgpsResetType()V
    ...
    .line 258
    .local v2, "types":[Ljava/lang/String;
    invoke-direct {p0}, Lcom/android/settings/location/AGPSSettings;->getPrefAgpsResetType()Ljava/lang/String;

    move-result-object v0

    .line 259
    .local v0, "defPref":Ljava/lang/String;
    iput-object v0, p0, Lcom/android/settings/location/AGPSSettings;->mResetType:Ljava/lang/String;
...
.method private setPrefAgpsType()V
    ...
    .line 207
    .local v2, "types":[Ljava/lang/String;
    invoke-direct {p0}, Lcom/android/settings/location/AGPSSettings;->getPrefAgpsType()Ljava/lang/String;

    move-result-object v0

    .line 208
    .local v0, "defPref":Ljava/lang/String;
    iput-object v0, p0, Lcom/android/settings/location/AGPSSettings;->mAssistedType:Ljava/lang/String;
...
.method private updateUI()V
    ...
    invoke-virtual {p0, v7}, Lcom/android/settings/location/AGPSSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-virtual {p0}, Lcom/android/settings/location/AGPSSettings;->getActivity()Landroid/app/Activity;
    ...
    .line 298
    iget-object v7, p0, Lcom/android/settings/location/AGPSSettings;->mServer:Landroid/preference/EditTextPreference;

    invoke-virtual {v7, v6}, Landroid/preference/EditTextPreference;->setEnabled(Z)V

    .line 299
    iget-object v7, p0, Lcom/android/settings/location/AGPSSettings;->mPort:Landroid/preference/EditTextPreference;
    ...
    .line 313
    :cond_1
    iget-object v5, p0, Lcom/android/settings/location/AGPSSettings;->mSwitch:Landroid/widget/Switch;
    ...
    .line 317
    :cond_4
    iget-object v6, p0, Lcom/android/settings/location/AGPSSettings;->mSwitch:Landroid/widget/Switch;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/location/AGPSSettings;->mContentResolver:Landroid/content/ContentResolver;

    .line 126
    iget-object v0, p0, Lcom/android/settings/location/AGPSSettings;->mContentResolver:Landroid/content/ContentResolver;
    ...
    iput-object v0, p0, Lcom/android/settings/location/AGPSSettings;->mContentQueryMap:Landroid/content/ContentQueryMap;

    .line 130
    const v0, 0x7f050004

    invoke-virtual {p0, v0}, Lcom/android/settings/location/AGPSSettings;->addPreferencesFromResource(I)V
    ...
    sput-object v0, Lcom/android/settings/location/AGPSSettings;->sNotSet:Ljava/lang/String;

    .line 136
    const-string v0, "server_addr"

    invoke-virtual {p0, v0}, Lcom/android/settings/location/AGPSSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v0

    check-cast v0, Landroid/preference/EditTextPreference;

    iput-object v0, p0, Lcom/android/settings/location/AGPSSettings;->mServer:Landroid/preference/EditTextPreference;
    ...
    iput-object v0, p0, Lcom/android/settings/location/AGPSSettings;->mPort:Landroid/preference/EditTextPreference;

    .line 139
    invoke-direct {p0, v8}, Lcom/android/settings/location/AGPSSettings;->fillUi(Z)V

    .line 141
    invoke-virtual {p0, v7}, Lcom/android/settings/location/AGPSSettings;->setHasOptionsMenu(Z)V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 445
    :pswitch_0
    invoke-direct {p0}, Lcom/android/settings/location/AGPSSettings;->saveAgpsParams()V

    goto :goto_0

    .line 449
    :pswitch_1
    invoke-direct {p0}, Lcom/android/settings/location/AGPSSettings;->restoreAgpsParam()V
...
.method public onPause()V
    ...
    .line 182
    iget-object v0, p0, Lcom/android/settings/location/AGPSSettings;->mSwitch:Landroid/widget/Switch;
    ...
    .line 184
    invoke-virtual {p0}, Lcom/android/settings/location/AGPSSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    .line 186
    iget-object v0, p0, Lcom/android/settings/location/AGPSSettings;->mContentQueryMap:Landroid/content/ContentQueryMap;

    iget-object v1, p0, Lcom/android/settings/location/AGPSSettings;->mSettingsObserver:Ljava/util/Observer;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    iput-object v5, p0, Lcom/android/settings/location/AGPSSettings;->mNetworkType:Ljava/lang/String;
    ...
    iput-object v5, p0, Lcom/android/settings/location/AGPSSettings;->mResetType:Ljava/lang/String;
    ...
    iput-object v5, p0, Lcom/android/settings/location/AGPSSettings;->mAssistedType:Ljava/lang/String;
...
.method public onResume()V
    ...
    iput-object v4, p0, Lcom/android/settings/location/AGPSSettings;->mSwitch:Landroid/widget/Switch;

    .line 152
    iget-object v4, p0, Lcom/android/settings/location/AGPSSettings;->mSwitch:Landroid/widget/Switch;
    ...
    .line 162
    .local v1, "padding":I
    iget-object v2, p0, Lcom/android/settings/location/AGPSSettings;->mSwitch:Landroid/widget/Switch;
    ...
    iget-object v3, p0, Lcom/android/settings/location/AGPSSettings;->mSwitch:Landroid/widget/Switch;
    ...
    .line 170
    iget-object v2, p0, Lcom/android/settings/location/AGPSSettings;->mContentQueryMap:Landroid/content/ContentQueryMap;

    iget-object v3, p0, Lcom/android/settings/location/AGPSSettings;->mSettingsObserver:Ljava/util/Observer;
...
.method public onSharedPreferenceChanged(Landroid/content/SharedPreferences;Ljava/lang/String;)V
    ...
    .prologue
    .line 343
    invoke-virtual {p0, p2}, Lcom/android/settings/location/AGPSSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
