...
.field static final TRANSACTION_addToWhiteList:I = 0x22
...
.field static final TRANSACTION_getActiveNotificationsFromListener:I = 0x13

.field static final TRANSACTION_getAutomaticZenModeConditions:I = 0x21

.field static final TRANSACTION_getEffectsSuppressor:I = 0x19

.field static final TRANSACTION_getHintsFromListener:I = 0x15

.field static final TRANSACTION_getHistoricalNotifications:I = 0xd

.field static final TRANSACTION_getInterruptionFilterFromListener:I = 0x17

.field static final TRANSACTION_getPackagePriority:I = 0x9

.field static final TRANSACTION_getPackageVisibilityOverride:I = 0xb

.field static final TRANSACTION_getWhiteList:I = 0x24

.field static final TRANSACTION_getZenModeConfig:I = 0x1b

.field static final TRANSACTION_matchesCallFilter:I = 0x1a

.field static final TRANSACTION_notifyConditions:I = 0x1d

.field static final TRANSACTION_registerListener:I = 0xe

.field static final TRANSACTION_removeAllNotifications:I = 0x10

.field static final TRANSACTION_removeFromWhiteList:I = 0x23

.field static final TRANSACTION_requestHintsFromListener:I = 0x14

.field static final TRANSACTION_requestInterruptionFilterFromListener:I = 0x16
...
.field static final TRANSACTION_setOnNotificationPostedTrimFromListener:I = 0x18
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 256
    .restart local v2    # "_arg1":I
    invoke-virtual {p0, v1, v2}, Landroid/app/INotificationManager$Stub;->removeAllNotifications(Ljava/lang/String;I)V
    ...
    .line 473
    sget-object v10, Landroid/app/NameInfo;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    .line 478
    .local v1, "_arg0":Landroid/app/NameInfo;
    :goto_7
    invoke-virtual {p0, v1}, Landroid/app/INotificationManager$Stub;->addToWhiteList(Landroid/app/NameInfo;)Z
    ...
    .line 476
    .end local v1    # "_arg0":Landroid/app/NameInfo;
    .end local v8    # "_result":Z
    :cond_d
    const/4 v1, 0x0

    .restart local v1    # "_arg0":Landroid/app/NameInfo;
    goto :goto_7
    ...
    .restart local v1    # "_arg0":Landroid/app/NameInfo;
    :goto_8
    invoke-virtual {p0, v1}, Landroid/app/INotificationManager$Stub;->removeFromWhiteList(Landroid/app/NameInfo;)Z
    ...
    .line 501
    invoke-virtual {p0}, Landroid/app/INotificationManager$Stub;->getWhiteList()[Landroid/app/NameInfo;

    move-result-object v8

    .line 502
    .local v8, "_result":[Landroid/app/NameInfo;
    invoke-virtual {p3}, Landroid/os/Parcel;->writeNoException()V
