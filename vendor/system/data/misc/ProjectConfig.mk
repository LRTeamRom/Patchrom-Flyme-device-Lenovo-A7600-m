...
#lenovo.sw START 20141110 wangsx3 config imgsensor
CUSTOM_HAL_FLASHLIGHT = dummy_flashlight
CUSTOM_HAL_IMGSENSOR = ov13850sunny_mipi_raw ov13850ofilm_mipi_raw hi551qtech_mipi_raw hi551qtechv2_mipi_raw
CUSTOM_HAL_LENS = dw9761sunnyaf dw9761ofilmaf dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =ov13850ofilm_mipi_raw
CUSTOM_HAL_MAIN_BACKUP_LENS=dw9761ofilmaf
CUSTOM_HAL_MAIN_IMGSENSOR = ov13850sunny_mipi_raw
CUSTOM_HAL_MAIN_LENS = dw9761sunnyaf
#lenovo.sw  END 20141110 wangsx3 checkin camera imgsenosr driver for AIO
...
#lenovo.sw END 20141110 wangsx3 config imgsensor
CUSTOM_KERNEL_ACCELEROMETER = mpu6515
CUSTOM_KERNEL_ALSPS = cm36652-new
#lenovo-sw molg1 add 20141029 begin
#CUSTOM_KERNEL_BAROMETER = BMP180-new
#lenovo-sw molg1 add 20141029 end
...
#lenovo-sw molg1 add 20141017 begin
#CUSTOM_KERNEL_GYROSCOPE = mpu6515
#lenovo-sw molg1 add 20141017 end
#lenovo jixu disable HDMI
CUSTOM_KERNEL_HDMI =
CUSTOM_KERNEL_HEADSET = accdet
#lenovo.sw START wangsx3 checkin camera imgsenosr driver for AIO
CUSTOM_KERNEL_IMGSENSOR = ov13850sunny_mipi_raw ov13850ofilm_mipi_raw hi551qtech_mipi_raw hi551qtechv2_mipi_raw
#lenovo.sw END wangsx3 checkin camera imgsenosr driver for AIO
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LCM = nt35595_fhd_dsi_cmd_truly_nt50358
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_MAGNETOMETER = yamaha532
#lenovo.sw START wangsx3 checkin camera imgsenosr driver for AIO
CUSTOM_KERNEL_LENS = dw9761sunnyaf dw9761ofilmaf dummy_lens
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =ov13850ofilm_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_LENS=dw9761ofilmaf
CUSTOM_KERNEL_MAIN_IMGSENSOR = ov13850sunny_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = dw9761sunnyaf
#lenovo.sw END wangsx3 checkin camera imgsenosr driver for AIO
CUSTOM_KERNEL_RTC = rtc
###=== lenovo-sw zhouwl,2014-11-03,AIO-5M use smartpa start
#CUSTOM_KERNEL_SOUND = amp_6323pmic_spk
CUSTOM_KERNEL_SOUND =
###=== lenovo-sw zhouwl,2014-11-03,AIO-5M use smartpa end
...
#Lenovo-sw linyf modify 2014-10-27 15:28 , change for AIO 3M project.
#CUSTOM_MODEM = mt6752k52_md1_lttg_dsds_prod mt6752k52_md1_lwg_dsds_prod
CUSTOM_MODEM = aio_3m_ltg_dsds
...
MTK_ATF_SUPPORT = yes
MTK_ATV_CHIP =
###=== lenovo-sw zhouwl,2014-11-03,disable audio enhancement start
#MTK_AUDENH_SUPPORT = yes
MTK_AUDENH_SUPPORT = no
###=== lenovo-sw zhouwl,2014-11-03,disable audio enhancement end
MTK_AUDIO = yes
...
##lenovo-sw heww3 20141126 close mtk audio profile
...
#lenovo-sw chenlj2 modify for NFC 2014-11-16 start
#MTK_BEAM_PLUS_SUPPORT = yes
MTK_BEAM_PLUS_SUPPORT = no
#lenovo-sw chenlj2 modify for NFC 2014-11-16 end
###=== lenovo-sw zhouwl,2014-11-03,disable mtk audio besloudness start
#MTK_BESLOUDNESS_SUPPORT = yes
MTK_BESLOUDNESS_SUPPORT = no
#MTK_BESSURROUND_SUPPORT = yes
MTK_BESSURROUND_SUPPORT = no
###=== lenovo-sw zhouwl,2014-11-03,disable mtk audio besloudness end
...
###=== lenovo-sw mahj2,2014-11-07 modify for use ncp1854 Begin
MTK_BQ24261_SUPPORT = no
###=== lenovo-sw mahj2,2014-11-07 modify for use ncp1854 End
...
# lenovo-sw oujf close BLE MANAGER 2014-11-13 begin
#MTK_BT_BLE_MANAGER_SUPPORT = yes
MTK_BT_BLE_MANAGER_SUPPORT = no
# lenovo-sw oujf close BLE MANAGER 2014-11-13 end
...
MTK_BT_SUPPORT = yes
MTK_BUILD_VERNO = ALPS.L0.MP6.V3_LENOVO6752.LWT.L_P240
MTK_BWC_SUPPORT = yes
...
#Lenovo-sw linyf modify 2014-11-19 15:28 , change for AIO CMCC project.
MTK_CTA_SET = yes
# Lenovo-sw oujf  enable CTA support for CTA,  2014-11-25 begin
#MTK_CTA_SUPPORT = no
MTK_CTA_SUPPORT = yes
# Lenovo-sw oujf  enable CTA support for CTA,  2014-11-25 end
...
#Lenovo-sw lixp5 modify 2014-01-15 begin, enable sim switch
MTK_DISABLE_CAPABILITY_SWITCH = no
#Lenovo-sw lixp5 modify 2014-01-15 end
...
#lenovo-sw shehh1 add dolby begin
DOLBY_SUPPORT = yes
LENOVO_UI_DOLBY_SUPPORT = yes 
#lenovo-sw shehh1 add boly end
# Lenovo-sw oujf remove DRM,2014-11-13 begin
#MTK_DRM_APP = yes
MTK_DRM_APP = no
# Lenovo-sw oujf remove DRM,2014-11-13 begin
MTK_DRM_KEY_MNG_SUPPORT = no
# Lenovo-sw wangxf14 add frp partition by mtk patch, begin
MTK_FACTORY_RESET_PROTECTION_SUPPORT = yes
# Lenovo-sw wangxf14 add frp partition by mtk patch, end
MTK_DRM_PLAYREADY_SUPPORT = no
MTK_DSPIRDBG = no
MTK_DTAG_DUAL_APN_SUPPORT = no
MTK_DT_SUPPORT = no
MTK_DUAL_INPUT_CHARGER_SUPPORT = no
###=== lenovo-sw zhouwl,2014-11-03,aio use dual-mic start
MTK_DUAL_MIC_SUPPORT = yes
###=== lenovo-sw zhouwl,2014-11-03,aio use dual-mic end
...
# Lenovo-sw oujf  close VIDEO EDITOR,  2014-11-13  begin
MTK_ENABLE_VIDEO_EDITOR=no
# Lenovo-sw oujf  close VIDEO EDITOR,  2014-11-13 end
...
# Lenovo-sw oujf  close VIDEO EDITOR,  2014-11-1 end
MTK_FIRST_MD = 1
#Lenovo-sw linyf modify 2014-11-19 15:28 , change for AIO 3M project.
...
MTK_FSCK_TUNE = no
#lenovo-sw oujf close FW UPGRADE ,2014-11-13 begin
#MTK_FW_UPGRADE = yes
MTK_FW_UPGRADE = no
#lenovo-sw oujf close FW UPGRADE ,2014-11-13 end
...
#lenovo-sw zhangli25 mtk_L_upgrade delete MTK_HUIYOU_LOVEFISHING_APP 20141117 begin
MTK_HOTKNOT_SUPPORT = no
#lenovo-sw zhangli25 mtk_L_upgrade delete MTK_HUIYOU_LOVEFISHING_APP 20141117 end
...
MTK_IMS_SUPPORT = no
###=== lenovo-sw zhouwl,2014-11-03,aio use dual-mic,depend on items start
#MTK_INCALL_HANDSFREE_DMNR = no
#MTK_INCALL_NORMAL_DMNR = no
MTK_INCALL_HANDSFREE_DMNR = yes
MTK_INCALL_NORMAL_DMNR = yes
###=== lenovo-sw zhouwl,2014-11-03,aio use dual-mic,depend on items end
...
MTK_LTE_SUPPORT = yes
MTK_M4U_SUPPORT = yes
# lenovo-sw zhouwl,2014-12-08,for call begin
#MTK_MAGICONFERENCE_SUPPORT = yes
MTK_MAGICONFERENCE_SUPPORT = no
# lenovo-sw zhouwl,2014-12-08,for call end
...
#lenovo  2014-11-10 chenlj2 modify for GPS 
...
#lenovo-sw zhangli25 begin
MTK_MULTICORE_OBSERVER_APP = no
#lenovo-sw zhangli25 end
...
MTK_NFC_SUPPORT = no
#lenovo-sw chenlj2 modify for NFC 2014-11-16 end
#Lenovo-sw oujf,2014-11-10,aio open del notebook ---begin
#MTK_NOTEBOOK_SUPPORT = yes
MTK_NOTEBOOK_SUPPORT = no
#Lenovo-sw oujf,2014-11-10,aio open del notebook ---end
MTK_NO_NEED_USB_LED = no
MTK_NO_TRAN_ANIM = no
MTK_NVRAM_SECURITY = no
MTK_OD_SUPPORT = no
MTK_OGM_PLAYBACK_SUPPORT = no
# Lenovo-sw oujf  close OMACP,  2014-11-13 begin
#MTK_OMACP_SUPPORT = yes
MTK_OMACP_SUPPORT = no
# Lenovo-sw oujf  close OMACP,  2014-11-13 end
MTK_OMADRM_SUPPORT = yes
MTK_OMA_DOWNLOAD_SUPPORT = yes
MTK_ONLY_OWNER_SIM_SUPPORT = no
# Lenovo-sw oujf  close OOBE,  2014-11-13 begin
MTK_OOBE_APP = no
# Lenovo-sw oujf  close OOBE,  2014-11-13 end
...
#Lenovo-sw oujf,2014-11-13,remove MTK_PERMISSION_CONTROL with LenovoSafeCenter ---begin
#MTK_PERMISSION_CONTROL = yes
MTK_PERMISSION_CONTROL = no
#Lenovo-sw oujf,2014-11-13,remove MTK_PERMISSION_CONTROL with LenovoSafeCenter ---end
...
# Lenovo-xm oujf remove MTK PPL,2014-11-13 begin
#MTK_PRIVACY_PROTECTION_LOCK = yes
MTK_PRIVACY_PROTECTION_LOCK = no
# Lenovo-xm oujf remove MTK PPL,2014-11-13 end
...
###Lenovo-sw mahj2 modify 2014-10-29 begin
MTK_PUMP_EXPRESS_SUPPORT = no
###Lenovo-sw mahj2 modify 2014-10-29 end
...
#Lenovo-sw zhucc2 chang for fuse ----start
#MTK_SHARED_SDCARD = no
MTK_SHARED_SDCARD = yes
#Lenovo-sw zhucc2 chang for fuse ------end
...
#Lenovo-sw linyf modify 2014-11-12 18:28 begin, change for AIO CMCC project.
MTK_SIM_HOT_SWAP = no
MTK_SIM_HOT_SWAP_COMMON_SLOT = no
#Lenovo-sw linyf modify 2014-11-12 18:28 end
...
# Lenovo-sw oujf open user2root 2014-11-13,begin
MTK_USER_ROOT_SWITCH = yes
# Lenovo-sw oujf open user2root 2014-11-13,end
...
# Lenovo-sw oujf  close VOICE UNLOCK,  2014-11-13 end
...
###=== lenovo-sw zhouwl,2014-11-03,aio 5M&3M use tfa9897 start
NXP_SMARTPA_SUPPORT = tfa9897
###=== lenovo-sw zhouwl,2014-11-03,aio 5M&3M use tfa9897 end
OP01_COMPATIBLE = no
OP01_CTS_COMPATIBLE_DFOSET = no
###=== lenovo-sw chenll4,2015-01-20 aio cmcc to open for ui&gui check TENMA-4569 start
#OPTR_SPEC_SEG_DEF = OP01_SPEC0200_SEGC
OPTR_SPEC_SEG_DEF = NONE
###=== lenovo-sw chenll4,2015-01-20 aio cmcc to open for ui&gui check TENMA-4569 end
#Lenovo-sw zhucc2 chang for fuse ----end
...
#CREATE_PROJECT_INFO=2014123014226

######## Lenovo BSP Feature begin ####################################################

###### Info #########################
#lenovo-sw jixj 2014.10.31 add
LENOVO_HARDWARE_ID = yes

###### Recover #########################
#Begin, Lenovo-sw wangxf14 add for lenovo recovery
LENOVO_RECOVERY_SUPPORT = yes
#End,   Lenovo-sw wangxf14 add for lenovo recovery
...
#lenovo-sw wuwl10 20150521 add for multi index color  begin
LENOVO_AIO_PQ_MULTI = yes
#lenovo-sw wuwl10 20150521 add for multi index color end
