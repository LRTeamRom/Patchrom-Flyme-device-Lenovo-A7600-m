...
.field protected static final EVENT_ABNORMAL_EVENT:I = 0x2c
...
.field protected static final EVENT_CFU_IND:I = 0x24

.field protected static final EVENT_CFU_QUERY_TIMEOUT:I = 0x28

.field protected static final EVENT_CHARGING_STOP:I = 0x2b

.field protected static final EVENT_CIPHER_INDICATION:I = 0x27

.field protected static final EVENT_CRSS_IND:I = 0x25
...
.field protected static final EVENT_RADIO_NOT_AVAILABLE:I = 0x22
...
.field protected static final EVENT_SET_BAND_MODE_DONE:I = 0x2d
...
.field protected static final EVENT_SIP_CALL_RING:I = 0x23
...
.field protected static final EVENT_VOICE_CALL_INCOMING_INDICATION:I = 0x26
...
.method protected constructor <init>(Ljava/lang/String;Lcom/android/internal/telephony/PhoneNotifier;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;ZI)V
    ...
    .line 258
    iput v5, p0, Lcom/android/internal/telephony/PhoneBase;->mPhoneRatFamily:I
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/PhoneBase;->mVoiceCallIncomingIndicationRegistrants:Landroid/os/RegistrantList;
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/PhoneBase;->mCipherIndicationRegistrants:Landroid/os/RegistrantList;
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/PhoneBase;->mSpeechCodecInfoRegistrants:Landroid/os/RegistrantList;
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/PhoneBase;->mPhoneRatFamilyChangedRegistrants:Landroid/os/RegistrantList;
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/PhoneBase;->mImsConferenceCallRegistrants:Landroid/os/RegistrantList;
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/PhoneBase;->mCallInfoChangedRegistrants:Landroid/os/RegistrantList;
    ...
    invoke-virtual {v3, p0, v8, v6}, Lcom/android/internal/telephony/uicc/UiccController;->registerForIccChanged(Landroid/os/Handler;ILjava/lang/Object;)V

    .line 484
    iget-object v3, p0, Lcom/android/internal/telephony/PhoneBase;->mUiccController:Lcom/android/internal/telephony/uicc/UiccController;

    invoke-virtual {v3, p0, v8, v6}, Lcom/android/internal/telephony/uicc/UiccController;->registerForApplicationChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    const-string v4, "clear network selection name"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 592
    .local v8, "s_fun":[Ljava/lang/String;
    const/4 v13, 0x2

    new-array v9, v13, [Ljava/lang/String;

    .line 593
    .local v9, "s_rat":[Ljava/lang/String;
    const/4 v13, 0x2
    ...
    const-string v14, "send special AT cmd to MD"
    ...
    invoke-virtual {v0, v8, v13}, Lcom/android/internal/telephony/PhoneBase;->invokeOemRilRequestStrings([Ljava/lang/String;Landroid/os/Message;)V
    ...
    const-string v15, "AT+ERFTX=1,0,0,"

    invoke-virtual {v14, v15}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v14

    const-string v15, "persist.radio.charging_stop"
    ...
    invoke-virtual {v0, v7, v13}, Lcom/android/internal/telephony/PhoneBase;->invokeOemRilRequestStrings([Ljava/lang/String;Landroid/os/Message;)V

    goto/16 :goto_0

    .line 611
    .end local v7    # "s":[Ljava/lang/String;
    .end local v8    # "s_fun":[Ljava/lang/String;
    .end local v9    # "s_rat":[Ljava/lang/String;
    :sswitch_3
    ...
    invoke-direct {v0, v13}, Lcom/android/internal/telephony/PhoneBase;->handleSetSelectNetwork(Landroid/os/AsyncResult;)V
    ...
    const-string v14, "Event EVENT_INITIATE_SILENT_REDIAL Received"
    ...
    invoke-virtual {v0, v4, v13, v14}, Lcom/android/internal/telephony/PhoneBase;->dialInternal(Ljava/lang/String;Lcom/android/internal/telephony/UUSInfo;I)Lcom/android/internal/telephony/Connection;
    :try_end_0
    ...
    const-string v15, "silent redial failed: "
    ...
    invoke-virtual {v0, v13}, Lcom/android/internal/telephony/PhoneBase;->onHandleSRVCC([I)V
    ...
    const-string v15, "Srvcc exception: "
    ...
    const-string v15, "EVENT_UNSOL_OEM_HOOK_RAW data="
    ...
    const-string v15, "OEM hook raw exception: "
    ...
    const-string v15, "Event EVENT_PHONE_RAT_FAMILY_CHANGED_NOTIFY "
    ...
    iget-object v15, v0, Lcom/android/internal/telephony/PhoneBase;->mPhoneRatFamilyChangedRegistrants:Landroid/os/RegistrantList;

    invoke-virtual {v15}, Landroid/os/RegistrantList;->size()I
    ...
    check-cast v13, Landroid/telephony/PhoneRatFamily;
    ...
    .line 664
    .local v6, "rat":Landroid/telephony/PhoneRatFamily;
    const-string v13, "PhoneBase"
    ...
    const-string v15, "update mPhoneRatFamily, , "
    ...
    iput v13, v0, Lcom/android/internal/telephony/PhoneBase;->mPhoneRatFamily:I

    .line 667
    .end local v6    # "rat":Landroid/telephony/PhoneRatFamily;
    :cond_6
    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/internal/telephony/PhoneBase;->mPhoneRatFamilyChangedRegistrants:Landroid/os/RegistrantList;
    ...
    invoke-virtual {v13, v14}, Landroid/os/RegistrantList;->get(I)Ljava/lang/Object;
    ...
    .line 669
    .local v11, "temp":Landroid/os/Registrant;
    const-string v13, "PhoneBase"
    ...
    invoke-virtual {v11}, Landroid/os/Registrant;->getHandler()Landroid/os/Handler;
    ...
    .line 671
    .end local v11    # "temp":Landroid/os/Registrant;
    :cond_7
    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/internal/telephony/PhoneBase;->mPhoneRatFamilyChangedRegistrants:Landroid/os/RegistrantList;
    ...
    const-string v15, "Event EVENT_SIP_CALL_RING Received state="
    ...
    iget v13, v0, Lcom/android/internal/telephony/PhoneBase;->mSipCallRingContinueToken:I
    ...
    iput v13, v0, Lcom/android/internal/telephony/PhoneBase;->mSipCallRingContinueToken:I
    ...
    iget v14, v0, Lcom/android/internal/telephony/PhoneBase;->mSipCallRingContinueToken:I

    const/4 v15, 0x0

    move-object/from16 v0, p0

    invoke-virtual {v0, v13, v14, v15}, Lcom/android/internal/telephony/PhoneBase;->obtainMessage(III)Landroid/os/Message;

    move-result-object v13

    move-object/from16 v0, p0

    iget v14, v0, Lcom/android/internal/telephony/PhoneBase;->mCallRingDelay:I

    int-to-long v14, v14

    move-object/from16 v0, p0

    invoke-virtual {v0, v13, v14, v15}, Lcom/android/internal/telephony/PhoneBase;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method public notifyCallInfoChanged(Lcom/android/internal/telephony/Connection;Landroid/os/Bundle;)V
    .locals 2
    .param p1, "connection"    # Lcom/android/internal/telephony/Connection;
    .param p2, "callInfo"    # Landroid/os/Bundle;
    ...
    invoke-direct {v0, p1, p2, v1}, Landroid/os/AsyncResult;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Throwable;)V
...
.method public notifyDataConnection(Ljava/lang/String;)V
    ...
    const-string v6, "Lenovo:notifyDataConnection... types.length == 0"
    ...
    invoke-virtual {p0, v7}, Lcom/android/internal/telephony/PhoneBase;->getDataConnectionState(Ljava/lang/String;)Lcom/android/internal/telephony/PhoneConstants$DataState;

    move-result-object v7

    invoke-interface {v5, p0, p1, v6, v7}, Lcom/android/internal/telephony/PhoneNotifier;->notifyDataConnection(Lcom/android/internal/telephony/Phone;Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/PhoneConstants$DataState;)V
...
.method public notifyHandoverStateChanged(Lcom/android/internal/telephony/Connection;Lcom/android/internal/telephony/Connection;)V
    .locals 4
    .param p1, "oldConn"    # Lcom/android/internal/telephony/Connection;
    .param p2, "newConn"    # Lcom/android/internal/telephony/Connection;
...
.method protected onHandleSRVCC([I)V
    .locals 5
    .param p1, "ret"    # [I
    ...
    .line 2440
    .local v1, "srvccState":Lcom/android/internal/telephony/Call$SrvccState;
    packed-switch v2, :pswitch_data_0

    .line 2454
    const-string v3, "PhoneBase"

    const-string v4, "Wrong correct SRVCC state received in onHandleSRVCC"

    invoke-static {v3, v4}, Landroid/telephony/Rlog;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 2465
    .end local v1    # "srvccState":Lcom/android/internal/telephony/Call$SrvccState;
    .end local v2    # "state":I
    :goto_0
    return-void

    .line 2442
    .restart local v1    # "srvccState":Lcom/android/internal/telephony/Call$SrvccState;
    ...
    invoke-virtual {v3, v1}, Lcom/android/internal/telephony/CallTracker;->onHandleSRVCC(Lcom/android/internal/telephony/Call$SrvccState;)V

    .line 2460
    new-instance v0, Landroid/telephony/VoLteServiceState;

    invoke-direct {v0, v2}, Landroid/telephony/VoLteServiceState;-><init>(I)V

    .line 2461
    .local v0, "lteState":Landroid/telephony/VoLteServiceState;
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/PhoneBase;->notifyVoLteServiceStateChanged(Landroid/telephony/VoLteServiceState;)V

    goto :goto_0

    .line 2445
    .end local v0    # "lteState":Landroid/telephony/VoLteServiceState;
    :pswitch_1
    ...
    const-string v4, "No SRVCC state received in onHandleSRVCC"
...
.method public registerForSpeechCodecInfo(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v0, v2, v1}, Lcom/android/internal/telephony/CommandsInterface;->setSpeechCodecInfo(ZLandroid/os/Message;)V
...
.method public unregisterForSpeechCodecInfo(Landroid/os/Handler;)V
    ...
    invoke-interface {v0, v1, v2}, Lcom/android/internal/telephony/CommandsInterface;->setSpeechCodecInfo(ZLandroid/os/Message;)V
...
.method protected updateImsPhone()V
    ...
    .line 2029
    invoke-static {}, Lcom/mediatek/internal/telephony/RadioManager;->getIMSService()Lcom/mediatek/internal/telephony/ims/ImsServiceStub;

    move-result-object v0

    iget-object v2, p0, Lcom/android/internal/telephony/PhoneBase;->mImsPhone:Lcom/android/internal/telephony/imsphone/ImsPhone;

    invoke-virtual {v0, v2}, Lcom/mediatek/internal/telephony/ims/ImsServiceStub;->setImsPhoneInstance(Lcom/android/internal/telephony/imsphone/ImsPhone;)V
