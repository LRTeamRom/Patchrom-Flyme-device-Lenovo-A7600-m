...
.method constructor <init>(Lcom/android/internal/telephony/gsm/GSMPhone;)V
    ...
    .line 106
    iput-boolean v1, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->hasPendingSwapRequest:Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 1163
    const-string v8, "GsmCallTracker"
    ...
    .line 1176
    const-string v8, "handle EVENT_POLL_CALLS_RESULT: set needsPoll=F"
    ...
    .line 1179
    iput-object v13, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mLastRelevantPoll:Landroid/os/Message;
    ...
    iput v10, v8, Lcom/android/internal/telephony/gsm/GsmConnection;->mCause:I

    .line 1196
    iget-object v8, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPendingMO:Lcom/android/internal/telephony/gsm/GsmConnection;

    invoke-virtual {v8, v10}, Lcom/android/internal/telephony/gsm/GsmConnection;->onDisconnect(I)Z

    .line 1197
    iput-object v13, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPendingMO:Lcom/android/internal/telephony/gsm/GsmConnection;
    ...
    :cond_3
    :goto_1
    iput-boolean v11, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->hasPendingSwapRequest:Z
    ...
    const-string v9, "Switch success, and then dial"
    ...
    invoke-static {v8}, Lcom/android/internal/telephony/gsm/GsmCallTracker$WaitingForHold;->access$000(Lcom/android/internal/telephony/gsm/GsmCallTracker$WaitingForHold;)Z
    ...
    invoke-virtual {v12}, Lcom/android/internal/telephony/gsm/GSMPhone;->getSubId()J

    move-result-wide v12

    invoke-virtual {v11, v12, v13}, Landroid/telephony/TelephonyManager;->getNetworkType(J)I
    ...
    .line 1301
    const-string v8, "dial call failed!!"
    ...
    const-string v9, "handle EVENT_CNAP_INDICATION : "
    ...
    const-string v9, "ringingCall.isIdle() : "
    ...
    iget-object v8, v8, Lcom/android/internal/telephony/gsm/GsmCall;->mConnections:Ljava/util/ArrayList;
    ...
    invoke-virtual {v2, v8}, Lcom/android/internal/telephony/gsm/GsmConnection;->setCnapName(Ljava/lang/String;)V
    ...
    iput-object v8, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPendingCnap:Ljava/lang/String;
    ...
    iput v8, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mSpeechCodecType:I
    ...
    const-string v9, "handle EVENT_SPEECH_CODEC_INFO : "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v9, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mSpeechCodecType:I
    ...
    invoke-virtual {v8, v9}, Lcom/android/internal/telephony/gsm/GSMPhone;->notifySpeechCodecInfo(I)V
...
.method protected declared-synchronized handlePollCalls(Landroid/os/AsyncResult;)V
    ...
    .line 616
    const-string v21, "case 1 : new Call appear"
    ...
    const-string v22, "poll: pendingMO="
    ...
    .line 652
    const-string v21, "MO/MT conflict! MO should be hangup by MD"
    ...
    invoke-virtual/range {v21 .. v22}, Lcom/android/internal/telephony/gsm/GsmConnection;->setCnapName(Ljava/lang/String;)V
    ...
    invoke-virtual/range {v21 .. v22}, Lcom/android/internal/telephony/gsm/GsmCallTrackerHelper;->DmCheckIfCallCanComing(Lcom/android/internal/telephony/gsm/GsmConnection;)Z

    move-result v6

    .line 669
    .local v6, "checkFlag":Z
    move-object/from16 v0, p0
    ...
    invoke-virtual {v0, v14, v1}, Lcom/android/internal/telephony/gsm/GsmCallTrackerHelper;->setForwardingAddressToConnection(ILcom/android/internal/telephony/Connection;)V
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/internal/telephony/gsm/GSMPhone;->getImsPhone()Lcom/android/internal/telephony/Phone;

    move-result-object v21

    check-cast v21, Lcom/android/internal/telephony/PhoneBase;
    ...
    invoke-virtual/range {v21 .. v22}, Lcom/android/internal/telephony/gsm/GsmConnection;->migrateFrom(Lcom/android/internal/telephony/Connection;)V
    ...
    invoke-virtual/range {v21 .. v23}, Lcom/android/internal/telephony/gsm/GSMPhone;->notifyHandoverStateChanged(Lcom/android/internal/telephony/Connection;Lcom/android/internal/telephony/Connection;)V
    ...
    .line 713
    const-string v21, "case 2 : old Call disappear"
    ...
    .line 715
    invoke-virtual {v7}, Lcom/android/internal/telephony/gsm/GsmConnection;->getCall()Lcom/android/internal/telephony/gsm/GsmCall;
    ...
    sget-object v22, Lcom/android/internal/telephony/Call$State;->WAITING:Lcom/android/internal/telephony/Call$State;
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/internal/telephony/gsm/GsmCallTrackerHelper;->CallIndicationEnd()V
    ...
    invoke-virtual {v0, v14}, Lcom/android/internal/telephony/gsm/GsmCallTrackerHelper;->clearForwardingAddressVariables(I)V
    ...
    .line 739
    const-string v21, "case 3 : old Call replaced"
    ...
    .line 761
    const-string v21, "case 4 : old Call update"
    ...
    .line 805
    const-string v21, "notifyNewRingingConnection"
    ...
    const-string v22, "dropped during poll size = "
    ...
    .line 819
    invoke-virtual {v7}, Lcom/android/internal/telephony/gsm/GsmConnection;->onHangupLocal()V
    ...
    .line 837
    invoke-virtual {v7, v4}, Lcom/android/internal/telephony/gsm/GsmConnection;->onDisconnect(I)Z
    ...
    .line 844
    :cond_1c
    const-string v21, "local hangup or invalid number"
    ...
    .line 875
    const-string v21, "notifyUnknownConnection"
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->hasPendingSwapRequest:Z
    ...
    .line 883
    const-string v21, "notifyPreciseCallStateChanged"
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/internal/telephony/gsm/GsmCallTrackerHelper;->getCurrentTotalConnections()I
...
.method protected onHandleSRVCC(Lcom/android/internal/telephony/Call$SrvccState;)V
    ...
    const-string v6, "SRVCC without ImsPhone!?"
    ...
    .line 1453
    :cond_0
    sget-object v5, Lcom/android/internal/telephony/Call$SrvccState;->STARTED:Lcom/android/internal/telephony/Call$SrvccState;
    ...
    const-string v6, "SRVCC Start!"

    invoke-static {v5, v6}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1455
    iput-object p1, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mSrvccState:Lcom/android/internal/telephony/Call$SrvccState;

    .line 1456
    invoke-virtual {v3, p1}, Lcom/android/internal/telephony/imsphone/ImsPhone;->notifyHandleSRVCC(Lcom/android/internal/telephony/Call$SrvccState;)V

    goto :goto_0

    .line 1458
    :cond_1
    sget-object v5, Lcom/android/internal/telephony/Call$SrvccState;->COMPLETED:Lcom/android/internal/telephony/Call$SrvccState;
    ...
    const-string v6, "SRVCC Completed! Start to do handover migration..."
    ...
    invoke-virtual {v5, v3}, Lcom/android/internal/telephony/gsm/GSMPhone;->migrateFrom(Lcom/android/internal/telephony/PhoneBase;)V

    .line 1465
    invoke-virtual {v3}, Lcom/android/internal/telephony/imsphone/ImsPhone;->getHandoverConnections()[Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;

    move-result-object v4

    .line 1466
    .local v4, "imsPhoneConnections":[Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;
    const/4 v2, 0x0
    ...
    invoke-virtual {v5}, Lcom/android/internal/telephony/imsphone/ImsPhoneCall;->isMultiparty()Z
    ...
    const-string v6, "SRVCC for conference connection"
    ...
    const-string v6, "There is a disconnected connection found, skip it..."
    ...
    invoke-virtual {v5}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->getCallId()I
    ...
    invoke-direct {p0, v5}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->getDriverCallStateFromCallState(Lcom/android/internal/telephony/Call$State;)Lcom/android/internal/telephony/DriverCall$State;

    move-result-object v5

    iput-object v5, v1, Lcom/android/internal/telephony/DriverCall;->state:Lcom/android/internal/telephony/DriverCall$State;

    .line 1480
    const/4 v5, 0x0

    iput-boolean v5, v1, Lcom/android/internal/telephony/DriverCall;->isMT:Z

    .line 1481
    const/4 v5, 0x1

    iput-boolean v5, v1, Lcom/android/internal/telephony/DriverCall;->isVoice:Z

    .line 1482
    const/16 v5, 0x81

    iput v5, v1, Lcom/android/internal/telephony/DriverCall;->TOA:I
    ...
    invoke-direct {v7, v8, v1, p0, v9}, Lcom/android/internal/telephony/gsm/GsmConnection;-><init>(Landroid/content/Context;Lcom/android/internal/telephony/DriverCall;Lcom/android/internal/telephony/gsm/GsmCallTracker;I)V
    ...
    invoke-virtual {v5, v6, v7}, Lcom/android/internal/telephony/gsm/GSMPhone;->notifyHandoverStateChanged(Lcom/android/internal/telephony/Connection;Lcom/android/internal/telephony/Connection;)V
    ...
    const-string v7, "SRVCC for normal connection["
    ...
    invoke-virtual {v7}, Lcom/android/internal/telephony/gsm/GsmConnection;->toString()Ljava/lang/String;
    ...
    invoke-virtual {v7}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->getState()Lcom/android/internal/telephony/Call$State;

    move-result-object v7

    invoke-direct {p0, v7}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->callStateToString(Lcom/android/internal/telephony/Call$State;)Ljava/lang/String;
    ...
    const-string v6, "SRVCC Completed! Handover migration finish..."
    ...
    .line 1503
    .end local v2    # "i":I
    .end local v4    # "imsPhoneConnections":[Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;
    :cond_5
    sget-object v5, Lcom/android/internal/telephony/Call$SrvccState;->FAILED:Lcom/android/internal/telephony/Call$SrvccState;
    ...
    .line 1506
    :cond_6
    sget-object v5, Lcom/android/internal/telephony/Call$SrvccState;->CANCELED:Lcom/android/internal/telephony/Call$SrvccState;
    ...
    const-string v6, "SRVCC Canceled!"
    ...
    const-string v6, "SRVCC abnormal case!"
...
.method switchWaitingOrHoldingAndActive()V
    ...
    .line 427
    :cond_0
    iget-boolean v0, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->hasPendingSwapRequest:Z
    ...
    iput-boolean v0, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->hasPendingSwapRequest:Z
