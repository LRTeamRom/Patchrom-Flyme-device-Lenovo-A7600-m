...
.method private createAccessibilityNodeInfoForNumberPicker(IIII)Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    invoke-static {v5}, Landroid/widget/NumberPicker;->access$6700(Landroid/widget/NumberPicker;)Landroid/content/Context;
    ...
    invoke-static {v5}, Landroid/widget/NumberPicker;->access$6800(Landroid/widget/NumberPicker;)Z
...
.method private createAccessibilityNodeInfoForVirtualButton(ILjava/lang/String;IIII)Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    # getter for: Landroid/widget/NumberPicker;->mContext:Landroid/content/Context;
    invoke-static {v4}, Landroid/widget/NumberPicker;->access$6500(Landroid/widget/NumberPicker;)Landroid/content/Context;
...
.method private createAccessibiltyNodeInfoForInputText(IIII)Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    # invokes: Landroid/widget/NumberPicker;->isVisibleToUser(Landroid/graphics/Rect;)Z
    invoke-static {v4, v0}, Landroid/widget/NumberPicker;->access$6400(Landroid/widget/NumberPicker;Landroid/graphics/Rect;)Z
...
.method private getVirtualDecrementButtonText()Ljava/lang/String;
    ...
    invoke-static {v1}, Landroid/widget/NumberPicker;->access$7000(Landroid/widget/NumberPicker;)Z
    ...
    invoke-static {v1, v0}, Landroid/widget/NumberPicker;->access$7100(Landroid/widget/NumberPicker;I)I
    ...
    invoke-static {v1}, Landroid/widget/NumberPicker;->access$7200(Landroid/widget/NumberPicker;)I
    ...
    invoke-static {v1}, Landroid/widget/NumberPicker;->access$1100(Landroid/widget/NumberPicker;)[Ljava/lang/String;
    ...
    invoke-static {v1, v0}, Landroid/widget/NumberPicker;->access$7300(Landroid/widget/NumberPicker;I)Ljava/lang/String;
    ...
    # getter for: Landroid/widget/NumberPicker;->mMinValue:I
    invoke-static {v2}, Landroid/widget/NumberPicker;->access$7200(Landroid/widget/NumberPicker;)I
...
.method public createAccessibilityNodeInfo(I)Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    # getter for: Landroid/widget/NumberPicker;->mSelectionDividerHeight:I
    invoke-static {v2}, Landroid/widget/NumberPicker;->access$4300(Landroid/widget/NumberPicker;)I
    ...
    # getter for: Landroid/widget/NumberPicker;->mRight:I
    invoke-static {v3}, Landroid/widget/NumberPicker;->access$4600(Landroid/widget/NumberPicker;)I
    ...
    # getter for: Landroid/widget/NumberPicker;->mLeft:I
    invoke-static {v4}, Landroid/widget/NumberPicker;->access$4700(Landroid/widget/NumberPicker;)I
    ...
    # getter for: Landroid/widget/NumberPicker;->mTop:I
    invoke-static {v7}, Landroid/widget/NumberPicker;->access$5400(Landroid/widget/NumberPicker;)I
...
.method public performAction(IILandroid/os/Bundle;)Z
    ...
    # getter for: Landroid/widget/NumberPicker;->mBottom:I
    invoke-static {v5}, Landroid/widget/NumberPicker;->access$5600(Landroid/widget/NumberPicker;)I
    ...
    # getter for: Landroid/widget/NumberPicker;->mTopSelectionDividerTop:I
    invoke-static {v4}, Landroid/widget/NumberPicker;->access$2200(Landroid/widget/NumberPicker;)I
