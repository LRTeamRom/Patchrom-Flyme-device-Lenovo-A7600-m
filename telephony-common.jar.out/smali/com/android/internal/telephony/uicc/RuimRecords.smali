...
.method public constructor <init>(Lcom/android/internal/telephony/uicc/UiccCardApplication;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;)V
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->mHandlePhbReadyReceiver:Landroid/content/BroadcastReceiver;

    .line 134
    invoke-virtual {p1}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->getSubId()J
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->mPhone:Lcom/android/internal/telephony/Phone;
    ...
    invoke-direct {v1, v2, p3, p1}, Lcom/android/internal/telephony/uicc/AdnRecordCache;-><init>(Lcom/android/internal/telephony/uicc/IccFileHandler;Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/uicc/UiccCardApplication;)V
    ...
    invoke-interface {v1, p0, v2, v5}, Lcom/android/internal/telephony/CommandsInterface;->registerForPhbReady(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    iget-object v2, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->mHandlePhbReadyReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-virtual {v1, p0, v2, v5}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->registerForReady(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    .line 162
    const-string v1, "RuimRecords updateIccRecords in IccPhoneBookeInterfaceManager"
    ...
    invoke-interface {v1}, Lcom/android/internal/telephony/Phone;->getIccPhoneBookInterfaceManager()Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;
    ...
    .line 167
    const-string v1, "RuimRecords : Phonebook is ready."
...
.method static synthetic access$1502(Lcom/android/internal/telephony/uicc/RuimRecords;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/telephony/uicc/RuimRecords;
    .param p1, "x1"    # Z
...
.method public broadcastPhbStateChangedIntent(Z)V
    ...
    invoke-virtual {v2}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->getSubId()J
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 543
    const-string v9, "handleMessage (EVENT_APP_READY)"
    ...
    invoke-static {v9, v10, v4}, Landroid/telephony/Rlog;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_2
    ...
    :sswitch_1
    :try_start_3
    const-string v9, "Event EVENT_GET_IMSI_RETRY Received, to get through ril"

    invoke-virtual {p0, v9}, Lcom/android/internal/telephony/uicc/RuimRecords;->log(Ljava/lang/String;)V

    .line 549
    iget-object v9, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->mCi:Lcom/android/internal/telephony/CommandsInterface;
    ...
    invoke-interface {v9, v10}, Lcom/android/internal/telephony/CommandsInterface;->getIMSI(Landroid/os/Message;)V
    :try_end_3
    ...
    iput-object v9, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->mImsi:Ljava/lang/String;
    ...
    const-string v10, "111111110000000"
    ...
    .line 588
    iget-object v9, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->mContext:Landroid/content/Context;

    const/4 v10, 0x0

    invoke-static {v9, v7, v10}, Lcom/android/internal/telephony/MccTable;->updateMccMncConfiguration(Landroid/content/Context;Ljava/lang/String;Z)V
    ...
    .line 599
    const-string v9, "cdma.icc.operator.mcc"
    ...
    invoke-static {v3, v9, v10}, Lcom/android/internal/telephony/uicc/IccUtils;->bcdToString([BII)Ljava/lang/String;
    ...
    iput-boolean v9, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->mPhbReady:Z

    .line 670
    iget-boolean v9, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->mPhbReady:Z

    invoke-virtual {p0, v9}, Lcom/android/internal/telephony/uicc/RuimRecords;->broadcastPhbStateChangedIntent(Z)V
    :try_end_4
    ...
    check-cast v8, Lcom/android/internal/telephony/uicc/IccRecords$IccRecordLoaded;

    .line 680
    .local v8, "recordLoaded":Lcom/android/internal/telephony/uicc/IccRecords$IccRecordLoaded;
    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    invoke-interface {v8}, Lcom/android/internal/telephony/uicc/IccRecords$IccRecordLoaded;->getEfName()Ljava/lang/String;
    ...
    const-string v10, "Record Load Exception: "
    ...
    new-instance v12, Lcom/android/internal/telephony/uicc/RuimRecords$EfCsimLiLoaded;

    const/4 v13, 0x0

    invoke-direct {v12, p0, v13}, Lcom/android/internal/telephony/uicc/RuimRecords$EfCsimLiLoaded;-><init>(Lcom/android/internal/telephony/uicc/RuimRecords;Lcom/android/internal/telephony/uicc/RuimRecords$1;)V
    ...
    .line 692
    iget v9, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->mRecordsToLoad:I

    add-int/lit8 v9, v9, 0x1

    iput v9, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->mRecordsToLoad:I
    :try_end_5
    ...
    :cond_b
    :try_start_7
    invoke-interface {v8, v2}, Lcom/android/internal/telephony/uicc/IccRecords$IccRecordLoaded;->onRecordLoaded(Landroid/os/AsyncResult;)V
    :try_end_7
    ...
    .line 715
    .end local v2    # "ar":Landroid/os/AsyncResult;
    .end local v8    # "recordLoaded":Lcom/android/internal/telephony/uicc/IccRecords$IccRecordLoaded;
    :catch_1
    move-exception v4
    ...
    .end local v4    # "exc":Ljava/lang/RuntimeException;
    .restart local v2    # "ar":Landroid/os/AsyncResult;
    .restart local v8    # "recordLoaded":Lcom/android/internal/telephony/uicc/IccRecords$IccRecordLoaded;
    :cond_c
    :try_start_a
    invoke-interface {v8}, Lcom/android/internal/telephony/uicc/IccRecords$IccRecordLoaded;->getEfName()Ljava/lang/String;
    ...
    new-instance v12, Lcom/android/internal/telephony/uicc/RuimRecords$EfCsimSpnLoaded;

    const/4 v13, 0x0

    invoke-direct {v12, p0, v13}, Lcom/android/internal/telephony/uicc/RuimRecords$EfCsimSpnLoaded;-><init>(Lcom/android/internal/telephony/uicc/RuimRecords;Lcom/android/internal/telephony/uicc/RuimRecords$1;)V
    ...
    new-instance v13, Lcom/android/internal/telephony/uicc/RuimRecords$EfCsimMdnLoaded;

    const/4 v14, 0x0

    invoke-direct {v13, p0, v14}, Lcom/android/internal/telephony/uicc/RuimRecords$EfCsimMdnLoaded;-><init>(Lcom/android/internal/telephony/uicc/RuimRecords;Lcom/android/internal/telephony/uicc/RuimRecords$1;)V

    invoke-virtual {p0, v12, v13}, Lcom/android/internal/telephony/uicc/RuimRecords;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v12

    invoke-virtual {v9, v10, v11, v12}, Lcom/android/internal/telephony/uicc/IccFileHandler;->loadEFLinearFixed(IILandroid/os/Message;)V
    ...
    new-instance v12, Lcom/android/internal/telephony/uicc/RuimRecords$EfCsimImsimLoaded;

    const/4 v13, 0x0

    invoke-direct {v12, p0, v13}, Lcom/android/internal/telephony/uicc/RuimRecords$EfCsimImsimLoaded;-><init>(Lcom/android/internal/telephony/uicc/RuimRecords;Lcom/android/internal/telephony/uicc/RuimRecords$1;)V
    ...
    const-string v10, "EF_CSIM_IMSIM"
    ...
    new-instance v12, Lcom/android/internal/telephony/uicc/RuimRecords$EfCsimCdmaHomeLoaded;

    const/4 v13, 0x0

    invoke-direct {v12, p0, v13}, Lcom/android/internal/telephony/uicc/RuimRecords$EfCsimCdmaHomeLoaded;-><init>(Lcom/android/internal/telephony/uicc/RuimRecords;Lcom/android/internal/telephony/uicc/RuimRecords$1;)V

    invoke-virtual {p0, v11, v12}, Lcom/android/internal/telephony/uicc/RuimRecords;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v11

    invoke-virtual {v9, v10, v11}, Lcom/android/internal/telephony/uicc/IccFileHandler;->loadEFLinearFixedAll(ILandroid/os/Message;)V
    ...
    const-string v10, "EF_CSIM_CDMAHOME"
    ...
    new-instance v13, Lcom/android/internal/telephony/uicc/RuimRecords$EfCsimEprlLoaded;

    const/4 v14, 0x0

    invoke-direct {v13, p0, v14}, Lcom/android/internal/telephony/uicc/RuimRecords$EfCsimEprlLoaded;-><init>(Lcom/android/internal/telephony/uicc/RuimRecords;Lcom/android/internal/telephony/uicc/RuimRecords$1;)V

    invoke-virtual {p0, v12, v13}, Lcom/android/internal/telephony/uicc/RuimRecords;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v12

    invoke-virtual {v9, v10, v11, v12}, Lcom/android/internal/telephony/uicc/IccFileHandler;->loadEFTransparent(IILandroid/os/Message;)V
