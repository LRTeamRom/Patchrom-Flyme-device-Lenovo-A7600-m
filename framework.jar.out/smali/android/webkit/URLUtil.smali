...
.field private static final BASE64_CONTENT_DISPOSITION_PATTERN:Ljava/util/regex/Pattern;
...
.method static constructor <clinit>()V
    ...
    .line 397
    const-string v0, "attachment;\\s*filename\\s*=\\s*(\"?)=\\?([a-zA-Z0-9-_]+)\\?B\\?([a-zA-Z0-9+/]*[=]{0,2})(\\?=)\\1\\s*$"

    invoke-static {v0, v1}, Ljava/util/regex/Pattern;->compile(Ljava/lang/String;I)Ljava/util/regex/Pattern;

    move-result-object v0

    sput-object v0, Landroid/webkit/URLUtil;->BASE64_CONTENT_DISPOSITION_PATTERN:Ljava/util/regex/Pattern;
...
.method public static guessUrl(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v5, "smartUrlFilter: failed to parse url = "
...
.method static parseContentDisposition(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_0
    sget-object v7, Landroid/webkit/URLUtil;->BASE64_CONTENT_DISPOSITION_PATTERN:Ljava/util/regex/Pattern;
    ...
    .line 444
    :try_start_2
    sget-object v7, Landroid/webkit/URLUtil;->CONTENT_DISPOSITION_PATTERN:Ljava/util/regex/Pattern;
    ...
    .line 433
    .local v6, "unsupportEx":Ljava/io/UnsupportedEncodingException;
    :try_start_3
    ...
    .line 438
    .end local v4    # "m":Ljava/util/regex/Matcher;
    .end local v6    # "unsupportEx":Ljava/io/UnsupportedEncodingException;
    :catch_1
    move-exception v0

    .line 439
    .local v0, "IllBase64Ex":Ljava/lang/IllegalStateException;
    const-string/jumbo v7, "webkit"
    ...
    const-string v9, "IllegalStateException: IllBase64Ex: "
    ...
    .line 434
    .end local v0    # "IllBase64Ex":Ljava/lang/IllegalStateException;
    .restart local v4    # "m":Ljava/util/regex/Matcher;
    :catch_2
    move-exception v3

    .line 435
    .local v3, "illEx":Ljava/lang/IllegalArgumentException;
    :try_start_4
    const-string/jumbo v7, "webkit"
    ...
    .line 448
    .end local v3    # "illEx":Ljava/lang/IllegalArgumentException;
    .end local v4    # "m":Ljava/util/regex/Matcher;
    :catch_3
    move-exception v1
    ...
    const-string v9, "IllegalStateException: ex: "
...
.method public static parseContentDispositionPublic(Ljava/lang/String;)Ljava/lang/String;
    .locals 1
    .param p0, "contentDisposition"    # Ljava/lang/String;
...
.method static testParseContentDisposition()V
    .locals 2
    ...
    const-string v1, "attachment; filename=\"image001.jpg\""

    invoke-static {v1}, Landroid/webkit/URLUtil;->parseContentDisposition(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v1, "attachment; filename=\"=?ISO-8859-1?B?aW1hZ2UwMDEuanBn?=\""
    ...
    const-string v1, "attachment; filename=\"=?UTF-8?B?aW1hZ2UwMDEuanBn?=\""
    ...
    const-string v1, "attachment; filename=\"=?GB2312?B?JWQ2JWQwJWNlJWM0JWJhJWJhJWQ3JWQ2?=\""
